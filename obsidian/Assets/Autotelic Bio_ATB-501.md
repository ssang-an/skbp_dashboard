...
record_id: "Autotelic Bio_ATB-501"
company: "Autotelic Bio"
...
ATB-501은 제공된 회사와의 정확한 asset identity가 공개 근거로 검증되지 않아 UNVERIFIED입니다.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 0 | triage_only | - | TR 0 points: ATB-501의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다. | 정확한 asset identity와 적응증이 먼저 확인되어야 합니다. | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0 points: ATB-501의 target 또는 MoA를 확인하지 못했습니다. | 기전 설명 또는 기능 검증 근거가 없습니다. | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: ATB-501에 대한 공개 asset-specific 결과를 확인하지 못했습니다. | 해석 가능한 정량 결과가 없습니다. | - |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 0 points: ATB-501의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다. |
| Why Not Higher | 정확한 asset identity와 적응증이 먼저 확인되어야 합니다. |
| Investigation Note | 회사 공식 pipeline의 현재 코드 목록을 확인했습니다. |

#### Conflicting Or Missing Evidence

- ATB-501 exact identity unresolved
...
| Rubric Definition | - |
| Judgment Reason | MOA 0 points: ATB-501의 target 또는 MoA를 확인하지 못했습니다. |
| Why Not Higher | 기전 설명 또는 기능 검증 근거가 없습니다. |
...
| Rubric Definition | - |
| Judgment Reason | Data 0 points: ATB-501에 대한 공개 asset-specific 결과를 확인하지 못했습니다. |
...
- Autotelic Bio current official pipeline lists ATB-320, ATB-720, ATB-810, and ATB-101, but not ATB-501.
- Autotelic Bio headquarters is in Republic of Korea.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Autotelic Bio_ATB-501`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Autotelic Bio_ATB-501",
  ...
  "input": {
    "company_input": "Autotelic Bio",
    "asset_input": "ATB-501"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "TR 0 points: ATB-501의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다."
  },
  "structured_table": {
    "company": "Autotelic Bio",
    "asset_name": "ATB-501",
    ...
    "sources": [
      {
        "source_title": "Autotelic Bio - Pipeline",
        "source_url": "https://www.autotelic.co.kr/en/sub/pipeline/pipeline.php"
      }
    ]
  },
  "hard_filter": {
    "status": "UNVERIFIED",
    "reason": "Autotelic Bio의 현재 공식 pipeline에서 ATB-501이라는 정확한 asset identifier를 확인하지 못했습니다.",
    "flags": [
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "main_line_summary": "TR 0 points: ATB-501의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다.",
        "why_not_higher": "정확한 asset identity와 적응증이 먼저 확인되어야 합니다.",
        "investigation_note": "회사 공식 pipeline의 현재 코드 목록을 확인했습니다.",
        "uncertain_points": [
          "ATB-501 exact identity unresolved"
        ],
        "source_ids": []
      ...
      "moa_validity": {
        ...
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "MOA 0 points: ATB-501의 target 또는 MoA를 확인하지 못했습니다.",
        "why_not_higher": "기전 설명 또는 기능 검증 근거가 없습니다.",
      ...
      "data_maturity": {
        ...
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "Data 0 points: ATB-501에 대한 공개 asset-specific 결과를 확인하지 못했습니다.",
  ...
  "final_insight": {
    "one_line_summary": "ATB-501은 제공된 회사와의 정확한 asset identity가 공개 근거로 검증되지 않아 UNVERIFIED입니다.",
    "recommendation": "Verify asset identity",
    "most_important_diligence_question": "ATB-501의 공식 명칭/alias 또는 원출처를 확보할 수 있는가?"
  },
  "triage": {
    "status": "UNVERIFIED",
    ...
    "why": "공식 회사 pipeline에는 다른 ATB 코드가 기재되어 있으나 ATB-501은 확인되지 않아 asset identity를 검증할 수 없습니다.",
    "missing_evidence_needed_for_full_scout": [
      "ATB-501을 Autotelic Bio의 특정 개발자산으로 연결하는 공식 pipeline, 발표자료, 특허 또는 registry 근거"
    ]
  }
}
```
