...
record_id: "Rapport_RAP-219_fast_triage_20260623"
company: "Rapport Therapeutics"
country: "United States"
asset: "RAP-219"
target: "TARPγ8-associated AMPA receptor modulation"
theme: "E/I Balance"
...
Novel synaptic E/I Balance asset with visible Phase 2 signal; run Full Scout.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | TARPγ8/AMPAR modulation directly affects excitatory synaptic transmission in seizure-relevant regions. |  | AES abstract: RAP-219 TARPγ8 NAM (https://aesnet.org/abstractslisting/efficacy-and-tolerability-of-rap-219-a-potential-first-in-class-negative-allosteric-modulator-of-%CE%B38-transmembrane-ampa-receptor-associated-protein-impact-on-rns-long-episodes-and-focal-seizures) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | TARPγ8-specific AMPAR NAM has visible clinical biomarker and seizure-response evidence. |  | Rapport RAP-219 Phase 2a follow-up results (https://investors.rapportrx.com/news-releases/news-release-details/rapport-therapeutics-presents-rap-219-focal-onset-seizure-phase/) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 2a clinical data and follow-up results are visible. |  | Rapport RAP-219 Phase 2a follow-up results (https://investors.rapportrx.com/news-releases/news-release-details/rapport-therapeutics-presents-rap-219-focal-onset-seizure-phase/) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TARPγ8/AMPAR modulation directly affects excitatory synaptic transmission in seizure-relevant regions. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| AES abstract: RAP-219 TARPγ8 NAM | publication | medium | - | RAP-219 is described as a selective TARPγ8 AMPAR NAM in focal seizures. | https://aesnet.org/abstractslisting/efficacy-and-tolerability-of-rap-219-a-potential-first-in-class-negative-allosteric-modulator-of-%CE%B38-transmembrane-ampa-receptor-associated-protein-impact-on-rns-long-episodes-and-focal-seizures |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | TARPγ8-specific AMPAR NAM has visible clinical biomarker and seizure-response evidence. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Source | Type | Reliability | Supports Score | Evidence Summary | URL |
|---|---|---|---|---|---|
| Rapport RAP-219 Phase 2a follow-up results | official_company | high | - | Phase 2a follow-up results showed sustained seizure and long-episode reductions. | https://investors.rapportrx.com/news-releases/news-release-details/rapport-therapeutics-presents-rap-219-focal-onset-seizure-phase/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Phase 2a clinical data and follow-up results are visible. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Full controlled Phase 3 data not yet available.
...
- RAP-219 is a TARPγ8-specific AMPAR NAM.
- Phase 2a FOS results and follow-up seizure reductions are publicly visible.

### Uncertain Points

- Fast triage did not validate all trial endpoints or trial registry details.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Synaptic Transmission|Synaptic Transmission]]
- Dashboard record id: `Rapport_RAP-219_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Rapport_RAP-219_fast_triage_20260623",
  ...
  "input": {
    "company_input": "Rapport Therapeutics",
    "asset_input": "RAP-219"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Synaptic Transmission",
    "target_description": "TARPγ8/AMPAR modulation directly affects excitatory synaptic transmission in seizure-relevant regions."
  },
  "structured_table": {
    "company": "Rapport Therapeutics",
    "asset_name": "RAP-219",
    "target": "TARPγ8-associated AMPA receptor modulation",
    "moa": "TARPγ8-specific AMPAR negative allosteric modulator",
    ...
    "sources": [
      {
        "source_title": "Rapport RAP-219 Phase 2a follow-up results",
        "source_url": "https://investors.rapportrx.com/news-releases/news-release-details/rapport-therapeutics-presents-rap-219-focal-onset-seizure-phase/"
      }
    ]
  },
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and TR/MOA/Data are all >=2; novel E/I Balance synaptic MoA with visible Phase 2a efficacy.",
    "flags": [
      "fast_triage_only",
      "novel_moa",
      "phase_2a_efficacy_visible"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "TARPγ8/AMPAR modulation directly affects excitatory synaptic transmission in seizure-relevant regions.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "TARPγ8-specific AMPAR NAM has visible clinical biomarker and seizure-response evidence.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Phase 2a clinical data and follow-up results are visible.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Full controlled Phase 3 data not yet available."
  ...
  "validation": {
    ...
    "source_registry": [
      {
        "source_id": "SRC_17a9d6bef348",
        "source_title": "Rapport RAP-219 Phase 2a follow-up results",
        "source_url": "https://investors.rapportrx.com/news-releases/news-release-details/rapport-therapeutics-presents-rap-219-focal-onset-seizure-phase/",
        "source_type": "official_company",
        "reliability": "high",
        "evidence_summary": "Phase 2a follow-up results showed sustained seizure and long-episode reductions."
      },
      {
        "source_id": "SRC_a34c8cea7e75",
        "source_title": "AES abstract: RAP-219 TARPγ8 NAM",
        "source_url": "https://aesnet.org/abstractslisting/efficacy-and-tolerability-of-rap-219-a-potential-first-in-class-negative-allosteric-modulator-of-%CE%B38-transmembrane-ampa-receptor-associated-protein-impact-on-rns-long-episodes-and-focal-seizures",
        "source_type": "publication",
        "reliability": "medium",
        "evidence_summary": "RAP-219 is described as a selective TARPγ8 AMPAR NAM in focal seizures."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "Novel synaptic E/I Balance asset with visible Phase 2 signal; run Full Scout.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "Is the RNS long-episode biomarker sufficiently validated to predict durable clinical seizure benefit?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Strong target/biology fit and visible Phase 2a clinical/biomarker response justify Full Scout.",
    "missing_evidence_needed_for_full_scout": [
      "Full Phase 2a dataset",
      "RNS biomarker-to-clinical seizure translatability",
      "Phase 3 initiation status",
      "Safety/tolerability versus standard ASMs"
    ]
  }
}
```
