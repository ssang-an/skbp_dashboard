...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | TARPγ8/AMPAR modulation directly affects excitatory synaptic transmission in seizure-relevant regions. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | TARPγ8-specific AMPAR NAM has visible clinical biomarker and seizure-response evidence. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 2a clinical data and follow-up results are visible. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #5"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "RAP-219는 FOS에서 novel synaptic transmission 조절 MoA와 Phase 2a seizure/biomarker response가 확인되어 Full Scout 우선순위가 높다.",
    "company_country": "United States"
  },
  "structured_table": {
    "company": "Rapport Therapeutics",
    "asset_name": "RAP-219",
    "target": "TARPγ8-associated AMPAR",
  ...
  "scoring": {
    ...
    "criteria": {
      "target_relevance": {
        ...
        "evidence_sources": [
          "https://aesnet.org/abstractslisting/efficacy-and-tolerability-of-rap-219-a-potential-first-in-class-negative-allosteric-modulator-of-%CE%B38-transmembrane-ampa-receptor-associated-protein-impact-on-rns-long-episodes-and-focal-seizures"
        ],
        "uncertain_points": []
      },
      "moa_validity": {
        ...
        "evidence_sources": [
          "https://investors.rapportrx.com/news-releases/news-release-details/rapport-therapeutics-presents-rap-219-focal-onset-seizure-phase/"
        ],
        "uncertain_points": []
      },
      "data_maturity": {
