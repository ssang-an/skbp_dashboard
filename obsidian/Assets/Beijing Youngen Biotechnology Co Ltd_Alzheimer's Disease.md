...
AD 질환명만으로는 Youngen의 특정 파이프라인 자산을 식별할 수 없습니다.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 0 | triage_only | - | TR 0점: AD라는 질환명만으로 특정 자산의 relevance를 평가할 수 없습니다. | 자산 identity가 없습니다. | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0점: 특정 자산의 표적·기전이 없습니다. | APP-siRNA를 이 입력에 자동 귀속하지 않았습니다. | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0점: 특정 자산별 결과가 없습니다. | 자산 identity가 먼저 필요합니다. | - |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 0점: AD라는 질환명만으로 특정 자산의 relevance를 평가할 수 없습니다. |
| Why Not Higher | 자산 identity가 없습니다. |
| Investigation Note | Youngen의 APP-siRNA 특허 프로그램은 확인했으나 이 입력명과 동일한 자산은 아닙니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 0점: 특정 자산의 표적·기전이 없습니다. |
| Why Not Higher | APP-siRNA를 이 입력에 자동 귀속하지 않았습니다. |
| Investigation Note | 정확한 program identifier가 필요합니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 0점: 특정 자산별 결과가 없습니다. |
| Why Not Higher | 자산 identity가 먼저 필요합니다. |
| Investigation Note | 특허 프로그램의 일반 설명만 확인됩니다. |
...
- Youngen의 AD APP-siRNA 특허 프로그램 존재
- 동일 명칭 자산 코드 미확인
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Beijing Youngen Biotechnology Co Ltd_Alzheimer's Disease`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Beijing Youngen Biotechnology Co Ltd_Alzheimer's Disease",
    "report_reupload_history": [
      {
        "id": "f0a98a94ab9540af806b320d03de97d8",
        "replaced_at": "2026-08-06T15:06:12.436562+00:00",
        "actor_ip": "127.0.0.1",
        "previous_record_id": "Beijing Youngen Biotechnology Co Ltd_Alzheimer's Disease",
        ...
        "previous_record_snapshot": {
          ...
          "input": {
            "company_input": "Beijing Youngen Biotechnology Co Ltd",
            "asset_input": "Alzheimer's Disease"
          },
          "json_summary": {
            "theme": "Unknown",
            "cluster": "Unknown",
            "target_description": "TR 0점: The indication is not tied to a verified asset."
          },
          "structured_table": {
            "company": "Beijing Youngen Biotechnology Co Ltd",
            "asset_name": "Alzheimer's Disease",
            "target": "Unknown",
            "moa": "Unknown",
            ...
            "sources": [
              {
                "source_title": "Youngen pipeline",
                "source_url": "https://www.youngenbiomed.com/pipeline.html"
              }
            ]
          },
          "hard_filter": {
            "status": "UNVERIFIED",
            "reason": "The asset field is only an indication.",
            "flags": [
              "identity_not_verified",
              "indication_used_as_asset_name"
            ],
            "hard_blocker": false,
          ...
          "scoring": {
            "criteria": {
              "target_relevance": {
                ...
                "evidence_type_reason": "TR 0점: The indication is not tied to a verified asset.",
                "evidence_basis": "no_supporting_basis",
                "main_line_summary": "TR 0점: The indication is not tied to a verified asset.",
                "why_not_higher": "",
                "investigation_note": "",
                "uncertain_points": [],
                "source_ids": []
              ...
              "moa_validity": {
                "score": 0,
                "evidence_type": "triage_only",
                "evidence_type_reason": "MOA 0점: No asset-specific target or MoA.",
                "evidence_basis": "no_supporting_basis",
                "main_line_summary": "MOA 0점: No asset-specific target or MoA.",
                "why_not_higher": "",
                "investigation_note": "",
                "uncertain_points": [],
                "source_ids": []
              ...
              "data_maturity": {
                "score": 0,
                "evidence_type": "triage_only",
                "evidence_type_reason": "Data 0점: No uniquely attributable result.",
                "evidence_basis": "no_supporting_basis",
                "main_line_summary": "Data 0점: No uniquely attributable result.",
                "why_not_higher": "",
                "investigation_note": "",
                "uncertain_points": [],
                "source_ids": []
          ...
          "validation": {
            "uncertain_points": [
              "A non-public code may exist."
            ],
            "cross_checked_facts": [
              "Youngen discloses CNS RNAi work and an APP-siRNA AD patent."
            ],
            "source_registry": [
              {
                "source_id": "S1",
                ...
                "evidence_summary": "Broad CNS pipeline, no asset with this name.",
                "verified": true
              },
              {
                "source_id": "S2",
                "source_title": "Youngen APP-siRNA AD patent",
                "source_url": "https://www.youngenbiomed.com/youngen-biotechnology-patent-for-small-nucleic-acid-therapeutic-drugs-for-alzheimers-disease-granted.html",
                "source_type": "official_company_news",
                "evidence_summary": "Relevant research, no candidate code/stage.",
                "verified": true
              }
            ]
          },
          "final_insight": {
            "one_line_summary": "UNVERIFIED: indication label, not a specific asset.",
            "recommendation": "Verify asset identity",
            "most_important_diligence_question": "What exact Youngen candidate code is behind this row?"
          },
          "triage": {
            "status": "UNVERIFIED",
            ...
            "why": "Youngen has relevant research, but no unique candidate is named.",
            "missing_evidence_needed_for_full_scout": [
              "Asset code",
              "Target, modality and current stage"
            ]
          }
        }
      }
    ...
    "edit_history": [
      {
        "changed_at": "2026-08-06T15:06:12.436590+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "",
    ...
    "last_edited_at": "2026-08-06T15:06:12.436590+00:00",
  ...
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "APP-siRNA 관련 프로그램은 있으나 'Alzheimer's Disease'는 특정 자산명이 아님."
  },
  "structured_table": {
    "company": "Beijing Youngen Biotechnology Co., Ltd.",
    "asset_name": "Alzheimer's Disease",
    ...
    "sources": [
      {
        "source_title": "Youngen APP siRNA patent announcement",
        "source_url": "https://www.youngenbiomed.com/youngen-biotechnology-patent-for-small-nucleic-acid-therapeutic-drugs-for-alzheimers-disease-granted.html"
      }
    ]
  },
  "hard_filter": {
    "status": "UNVERIFIED",
    "reason": "질환명이 asset name으로 입력되어 특정 자산 identity가 확인되지 않습니다.",
    "flags": [
      "indication_used_as_asset_name",
      "no_discrete_asset_code"
    ],
    "hard_blocker": false,
    "decision_uncertainty": false
  },
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "TR 0점: AD라는 질환명만으로 특정 자산의 relevance를 평가할 수 없습니다.",
        "why_not_higher": "자산 identity가 없습니다.",
        "investigation_note": "Youngen의 APP-siRNA 특허 프로그램은 확인했으나 이 입력명과 동일한 자산은 아닙니다.",
        "uncertain_points": [],
        "source_ids": []
      },
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "MOA 0점: 특정 자산의 표적·기전이 없습니다.",
        "why_not_higher": "APP-siRNA를 이 입력에 자동 귀속하지 않았습니다.",
        "investigation_note": "정확한 program identifier가 필요합니다.",
        "uncertain_points": [],
        "source_ids": []
      },
      "data_maturity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "Data 0점: 특정 자산별 결과가 없습니다.",
        "why_not_higher": "자산 identity가 먼저 필요합니다.",
        "investigation_note": "특허 프로그램의 일반 설명만 확인됩니다.",
        "uncertain_points": [],
        "source_ids": []
      }
    },
  ...
  "final_insight": {
    "one_line_summary": "AD 질환명만으로는 Youngen의 특정 파이프라인 자산을 식별할 수 없습니다.",
    "recommendation": "Verify asset identity",
    "most_important_diligence_question": "Youngen의 정확한 자산 코드 또는 patent-linked candidate name은 무엇인가?"
  },
  "triage": {
    "status": "UNVERIFIED",
    "identity_verified": false,
    ...
    "why": "질환명이 asset name으로 입력됐으며 Youngen의 공개자료에서도 해당 명칭의 독립 자산 코드를 확인하지 못했습니다.",
    "missing_evidence_needed_for_full_scout": [
      "정확한 자산 코드 또는 특허 후보명",
      "공식 pipeline row"
    ]
