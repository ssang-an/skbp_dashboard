...
| Rubric Definition | - |
| Judgment Reason | TR 0점: Claimed AD indication is not asset-verified. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Rubric Definition | - |
| Judgment Reason | MOA 0점: 'Inhibit tau' is not a confirmed specific mechanism. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Rubric Definition | - |
| Judgment Reason | Data 0점: No asset-specific result found. |
| Why Not Higher |  |
| Investigation Note |  |
