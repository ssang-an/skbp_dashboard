...
record_id: "Illimis Therapeutics, Inc._ILM01"
company: "Illimis Therapeutics, Inc."
country: "Republic of Korea"
asset: "ILM01"
target: "Amyloid beta (Aβ) and TAM receptors"
theme: "Neuroimmune"
cluster: "Unknown"
...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | TR 3점: AD 적응증과 Aβ/TAM 직접 질환·기전 연결이 확인됩니다. | 최고점입니다. | Illimis official pipeline (https://illimistx.com/en/sub/platform%26pipeline/pipeline.php)<br>Illimis GAIA platform description (https://illimistx.com/en/sub/platform%26pipeline/platform.php) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | MOA 3점: GAIA-Aβ prototype가 phagocytosis/anti-inflammatory 설계와 비교 기능성 PoC를 보였습니다. | 최종 ILM01 후보의 target-engagement 수치는 제한적입니다. | Illimis GAIA platform description (https://illimistx.com/en/sub/platform%26pipeline/platform.php)<br>Anti-inflammatory clearance of amyloid beta by a chimeric Gas6 fusion protein (https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.072368) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 1 | triage_only | - | Data 1점: improved efficacy/safety 및 amyloid/neuroinflammation 감소가 정성적으로 공개됐습니다. | 정량 효과크기·PK·안전성 수치가 제한적입니다. | Illimis GAIA platform description (https://illimistx.com/en/sub/platform%26pipeline/platform.php)<br>Anti-inflammatory clearance of amyloid beta by a chimeric Gas6 fusion protein (https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.072368) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 3점: AD 적응증과 Aβ/TAM 직접 질환·기전 연결이 확인됩니다. |
| Why Not Higher | 최고점입니다. |
| Investigation Note | 공식 pipeline과 platform을 확인했습니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 3점: GAIA-Aβ prototype가 phagocytosis/anti-inflammatory 설계와 비교 기능성 PoC를 보였습니다. |
| Why Not Higher | 최종 ILM01 후보의 target-engagement 수치는 제한적입니다. |
| Investigation Note | prototype와 최종 후보의 동일성 범위를 Full Scout에서 확인해야 합니다. |
...
|---|---|---|---|---|---|
| Illimis GAIA platform description | official_company_platform | - | - | - | https://illimistx.com/en/sub/platform%26pipeline/platform.php |
| Anti-inflammatory clearance of amyloid beta by a chimeric Gas6 fusion protein | peer_reviewed_conference_abstract | - | - | - | https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.072368 |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 1점: improved efficacy/safety 및 amyloid/neuroinflammation 감소가 정성적으로 공개됐습니다. |
| Why Not Higher | 정량 효과크기·PK·안전성 수치가 제한적입니다. |
| Investigation Note | 학회/공식 설명을 넘어 원자료가 필요합니다. |
...
- Theme: [[Theme - Neuroimmune|Neuroimmune]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Illimis Therapeutics, Inc._ILM01`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Illimis Therapeutics, Inc._ILM01",
    "storage_profile": "dashboard_hybrid_v1",
    "collaboration": {
      "comments": [
        {
          "id": "01b1c329b89e4b85bbb3dc4f392d428f",
          "parent_id": null,
          "author": "정주원",
          "author_user_id": "",
          "author_email": "",
          ...
          "updated_at": "2026-08-24T10:06:20.356873+00:00",
    ...
    "edit_history": [
      {
        "id": "59d39b64c14641ea80a0f289f733dd90",
        "changed_at": "2026-08-24T10:06:20.356879+00:00",
        "actor_ip": "system",
        "actor_name": "",
  ...
  "json_summary": {
    "theme": "Neuroimmune",
    "cluster": "Unknown",
    "target_description": "Aβ와 TAM receptor를 연결해 염증을 제한하며 amyloid clearance를 유도하는 GAIA lead."
  },
  "structured_table": {
    "company": "Illimis Therapeutics, Inc.",
    "asset_name": "ILM01",
    "target": "Amyloid beta (Aβ) and TAM receptors",
    "moa": "GAIA fusion protein couples Aβ binding to TAM-receptor-mediated phagocytosis with anti-inflammatory signaling",
  ...
  "hard_filter": {
    "status": "SELECT",
    "reason": "SELECT 조건 충족: identity와 active status가 확인되고 TR 3점·MOA 3점입니다.",
    "flags": [
      "active_preclinical_asset",
      "interest_indication",
      "asset_specific_functional_moa"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "main_line_summary": "TR 3점: AD 적응증과 Aβ/TAM 직접 질환·기전 연결이 확인됩니다.",
        "why_not_higher": "최고점입니다.",
        "investigation_note": "공식 pipeline과 platform을 확인했습니다.",
        "uncertain_points": [],
        "source_ids": [
          "ILM01_1",
          "ILM01_2"
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 3점: GAIA-Aβ prototype가 phagocytosis/anti-inflammatory 설계와 비교 기능성 PoC를 보였습니다.",
        "why_not_higher": "최종 ILM01 후보의 target-engagement 수치는 제한적입니다.",
        "investigation_note": "prototype와 최종 후보의 동일성 범위를 Full Scout에서 확인해야 합니다.",
        "uncertain_points": [
          "prototype-to-candidate continuity"
        ],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "Data 1점: improved efficacy/safety 및 amyloid/neuroinflammation 감소가 정성적으로 공개됐습니다.",
        "why_not_higher": "정량 효과크기·PK·안전성 수치가 제한적입니다.",
        "investigation_note": "학회/공식 설명을 넘어 원자료가 필요합니다.",
        "uncertain_points": [
          "정량 원자료 제한"
        ],
        "source_ids": [
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "ILM01_3",
        "source_title": "Anti-inflammatory clearance of amyloid beta by a chimeric Gas6 fusion protein",
        "source_url": "https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.072368",
  ...
  "final_insight": {
    "one_line_summary": "차별화된 Aβ/TAM neuroimmune AD lead로 Full Scout 권고.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "최종 ILM01 후보의 정량 amyloid clearance, ARIA-relevant safety 및 brain exposure는 무엇인가?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "활성 AD lead이며 Aβ/TAM 직접 MoA와 prototype functional PoC가 확인되어 SELECT입니다.",
    "missing_evidence_needed_for_full_scout": [
      "ILM01 candidate-specific quantitative package",
      "PK/brain exposure",
