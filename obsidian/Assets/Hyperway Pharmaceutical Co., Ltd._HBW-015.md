...
country: "China"
asset: "HBW-015"
target: "Undisclosed nociceptive ion channel"
theme: "Others"
cluster: "Others"
...
| Stage | Preclinical unspecified |
| Indication | Pain; efficacy tested in acute and CCI neuropathic pain models |
...
전임상 데이터는 강하지만 generic Pain·미공개 표적·현재 활동 불확실로 REJECT.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 1 | triage_only | - | TR 1점: 통증 프로그램과 CCI 신경병증성 통증 모델은 확인되지만 공식 적응증은 generic Pain입니다. | 명시적 neuropathic pain 임상 적응증이 확인되지 않았습니다. | BioTianFu report on Hyperway analgesic HBW-015-15 (https://www.tianfulifesciencepark.com/News/Detail?id=2657) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0점: 미공개 통증감지 ion channel 억제제로만 설명돼 표적·기전을 충분히 확인할 수 없습니다. | 표적명이 공개되지 않았습니다. | BioTianFu report on Hyperway analgesic HBW-015-15 (https://www.tianfulifesciencepark.com/News/Detail?id=2657) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Data 3점: PK, 급성·CCI 효능, selectivity 및 14일 독성의 다중 정량 도메인이 공개됐습니다. | 임상 데이터는 없지만 전임상 단계에서는 최고점 기준을 충족합니다. | BioTianFu report on Hyperway analgesic HBW-015-15 (https://www.tianfulifesciencepark.com/News/Detail?id=2657) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 1점: 통증 프로그램과 CCI 신경병증성 통증 모델은 확인되지만 공식 적응증은 generic Pain입니다. |
| Why Not Higher | 명시적 neuropathic pain 임상 적응증이 확인되지 않았습니다. |
| Investigation Note | 동물모델을 임상 적응증으로 승격하지 않았습니다. |

#### Conflicting Or Missing Evidence

- 공식 lead pain subtype
...
|---|---|---|---|---|---|
| BioTianFu report on Hyperway analgesic HBW-015-15 | biotech_park_company_report | - | - | - | https://www.tianfulifesciencepark.com/News/Detail?id=2657 |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 0점: 미공개 통증감지 ion channel 억제제로만 설명돼 표적·기전을 충분히 확인할 수 없습니다. |
| Why Not Higher | 표적명이 공개되지 않았습니다. |
| Investigation Note | HBW-015-15의 표적명과 직접 assay가 필요합니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 3점: PK, 급성·CCI 효능, selectivity 및 14일 독성의 다중 정량 도메인이 공개됐습니다. |
| Why Not Higher | 임상 데이터는 없지만 전임상 단계에서는 최고점 기준을 충족합니다. |
| Investigation Note | 대표물질 HBW-015-15 데이터가 HBW-015 프로그램에 귀속됩니다. |
...
- 경구 PK
- 급성·CCI 효능
- kinase/ion-channel selectivity
- 14일 rat toxicology

### Uncertain Points

- HBW-015와 HBW-015-15의 명명 관계
- 2026년 active status
- 표적명
...
- Theme: [[Theme - Others|Others]]
- Cluster: [[Cluster - Others|Others]]
- Dashboard record id: `Hyperway Pharmaceutical Co., Ltd._HBW-015`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Hyperway Pharmaceutical Co., Ltd._HBW-015",
  ...
  "json_summary": {
    "theme": "Others",
    "cluster": "Others",
    "target_description": "표적명이 비공개된 비마약성 진통 저분자 프로그램; HBW-015-15 대표물질 데이터 공개."
  },
  "structured_table": {
    "company": "Hyperway Pharmaceutical Co., Ltd.",
    "asset_name": "HBW-015",
    "target": "Undisclosed nociceptive ion channel",
    "moa": "Inhibitor of an undisclosed nociceptive ion channel",
    ...
    "sources": [
      {
        "source_title": "BioTianFu report on Hyperway analgesic HBW-015-15",
        "source_url": "https://www.tianfulifesciencepark.com/News/Detail?id=2657"
      }
    ]
  },
  "hard_filter": {
    "status": "REJECT",
    "reason": "identity는 확인되지만 active_asset=null이며 SKBP fit과 MoA 정보가 부족합니다.",
    "flags": [
      "generic_pain",
      "undisclosed_target",
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "main_line_summary": "TR 1점: 통증 프로그램과 CCI 신경병증성 통증 모델은 확인되지만 공식 적응증은 generic Pain입니다.",
        "why_not_higher": "명시적 neuropathic pain 임상 적응증이 확인되지 않았습니다.",
        "investigation_note": "동물모델을 임상 적응증으로 승격하지 않았습니다.",
        "uncertain_points": [
          "공식 lead pain subtype"
        ],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 0점: 미공개 통증감지 ion channel 억제제로만 설명돼 표적·기전을 충분히 확인할 수 없습니다.",
        "why_not_higher": "표적명이 공개되지 않았습니다.",
        "investigation_note": "HBW-015-15의 표적명과 직접 assay가 필요합니다.",
        "uncertain_points": [
          "표적 identity"
        ],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "Data 3점: PK, 급성·CCI 효능, selectivity 및 14일 독성의 다중 정량 도메인이 공개됐습니다.",
        "why_not_higher": "임상 데이터는 없지만 전임상 단계에서는 최고점 기준을 충족합니다.",
        "investigation_note": "대표물질 HBW-015-15 데이터가 HBW-015 프로그램에 귀속됩니다.",
        "uncertain_points": [
          "정확한 PCC 코드 관계"
        ],
        "source_ids": [
    ...
    "source_registry": [
      {
        ...
        "source_title": "BioTianFu report on Hyperway analgesic HBW-015-15",
        "source_url": "https://www.tianfulifesciencepark.com/News/Detail?id=2657",
        "source_type": "biotech_park_company_report",
        "verified": true
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "전임상 데이터는 강하지만 generic Pain·미공개 표적·현재 활동 불확실로 REJECT.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "HBW-015의 정확한 표적과 2026년 active pipeline status는 무엇인가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "다중 전임상 데이터는 강하지만 generic Pain이고 표적명이 비공개이며 2026년 현재 활동이 확인되지 않아 REJECT입니다.",
    "missing_evidence_needed_for_full_scout": [
      "현재 공식 pipeline status",
      "표적명",
      "임상 후보 지정 여부"
    ]
  }
