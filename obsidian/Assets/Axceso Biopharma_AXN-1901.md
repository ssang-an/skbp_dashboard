...
record_id: "Axceso Biopharma_AXN-1901"
company: "Axceso Biopharma"
...
AXN-1901은 Parkinson/SIRT1 asset identity는 확인되지만 최신 snapshot에서 discontinued이므로 REJECT입니다.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 2 | triage_only | - | TR 2 points: AXN-1901의 indication은 Parkinson disease로 확인되어 SKBP interest indication에 해당합니다. | SIRT1 mechanism이 이 asset의 Parkinson disease biology와 직접 연결된 검증 근거는 quick triage에서 확인하지 못했습니다. | Synapse - Axceso Biopharma Co. Ltd. pipeline (https://synapse.patsnap.com/organization/9e5e4b40b472ceabb19a88c37b5340f0)<br>Synapse - AXN-1901 (https://synapse.patsnap.com/drug/018ac73cccde49b297c26ece067c08df) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 1 | triage_only | - | MOA 1 points: AXN-1901은 SIRT1 stimulant로 기술됩니다. | asset-specific functional evidence, target engagement 또는 mechanism-linked PD/biomarker를 확인하지 못했습니다. | Synapse - AXN-1901 (https://synapse.patsnap.com/drug/018ac73cccde49b297c26ece067c08df) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: dedicated public drug page에서 AXN-1901의 clinical result가 No Data로 표시되며 별도 asset-specific 결과를 확인하지 못했습니다. | 해석 가능한 공개 asset-specific 결과가 없습니다. | Synapse - AXN-1901 (https://synapse.patsnap.com/drug/018ac73cccde49b297c26ece067c08df) |
| Marketability | - | - | - | - | - | - |
...
| Evidence Type Reason | Parkinson disease 적응증은 검증되지만 TR 3에 필요한 직접 biology linkage는 확인되지 않았습니다. |
| Rubric Definition | - |
| Judgment Reason | TR 2 points: AXN-1901의 indication은 Parkinson disease로 확인되어 SKBP interest indication에 해당합니다. |
| Why Not Higher | SIRT1 mechanism이 이 asset의 Parkinson disease biology와 직접 연결된 검증 근거는 quick triage에서 확인하지 못했습니다. |
| Investigation Note | 최신 pipeline snapshot과 dedicated drug record에서 indication/target을 교차확인했습니다. |
...
|---|---|---|---|---|---|
| Synapse - Axceso Biopharma Co. Ltd. pipeline | biopharma intelligence database | - | - | - | https://synapse.patsnap.com/organization/9e5e4b40b472ceabb19a88c37b5340f0 |
| Synapse - AXN-1901 | biopharma intelligence database | - | - | - | https://synapse.patsnap.com/drug/018ac73cccde49b297c26ece067c08df |
...
| Score | 1 |
| Evidence Type | triage_only |
| Evidence Type Reason | 기전 description은 확인되지만 높은 점수에 필요한 검증 근거가 없습니다. |
| Rubric Definition | - |
| Judgment Reason | MOA 1 points: AXN-1901은 SIRT1 stimulant로 기술됩니다. |
| Why Not Higher | asset-specific functional evidence, target engagement 또는 mechanism-linked PD/biomarker를 확인하지 못했습니다. |
| Investigation Note | dedicated drug page의 target/action/mechanism을 확인했습니다. |
...
| Rubric Definition | - |
| Judgment Reason | Data 0 points: dedicated public drug page에서 AXN-1901의 clinical result가 No Data로 표시되며 별도 asset-specific 결과를 확인하지 못했습니다. |
| Why Not Higher | 해석 가능한 공개 asset-specific 결과가 없습니다. |
| Investigation Note | 공개 dedicated drug record를 확인했습니다. |
...
- Newer Axceso pipeline snapshot lists AXN-1901 (SIRT1), Parkinson Disease, Discontinued.
- Older dedicated AXN-1901 record lists small molecule, SIRT1 stimulant, Parkinson Disease, preclinical, and No Data.

### Uncertain Points

- Older dedicated AXN-1901 page lists active preclinical status, while the newer 15 Aug 2026 organization pipeline snapshot lists Discontinued; the newer current snapshot was used.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Axceso Biopharma_AXN-1901`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Axceso Biopharma_AXN-1901",
  ...
  "input": {
    "company_input": "Axceso Biopharma",
    "asset_input": "AXN-1901"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Small-molecule SIRT1 stimulant program previously associated with Parkinson disease."
  },
  "structured_table": {
    "company": "Axceso Biopharma",
    "asset_name": "AXN-1901",
    ...
    "sources": [
      {
        "source_title": "Synapse - Axceso Biopharma Co. Ltd. pipeline",
        "source_url": "https://synapse.patsnap.com/organization/9e5e4b40b472ceabb19a88c37b5340f0"
      }
    ]
  },
  "hard_filter": {
    "status": "REJECT",
    "reason": "2026-08 current-project snapshot에서 AXN-1901이 Discontinued로 표시되어 lifecycle hard blocker가 적용됩니다.",
    "flags": [
      "inactive_asset",
      "discontinued",
      "status_conflict_resolved_by_newer_source"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "Parkinson disease 적응증은 검증되지만 TR 3에 필요한 직접 biology linkage는 확인되지 않았습니다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 2 points: AXN-1901의 indication은 Parkinson disease로 확인되어 SKBP interest indication에 해당합니다.",
        "why_not_higher": "SIRT1 mechanism이 이 asset의 Parkinson disease biology와 직접 연결된 검증 근거는 quick triage에서 확인하지 못했습니다.",
        "investigation_note": "최신 pipeline snapshot과 dedicated drug record에서 indication/target을 교차확인했습니다.",
        "uncertain_points": [
          "Direct asset-specific disease-biology linkage not established"
        ],
        "source_ids": [
      ...
      "moa_validity": {
        "score": 1,
        "evidence_type": "triage_only",
        "evidence_type_reason": "기전 description은 확인되지만 높은 점수에 필요한 검증 근거가 없습니다.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 1 points: AXN-1901은 SIRT1 stimulant로 기술됩니다.",
        "why_not_higher": "asset-specific functional evidence, target engagement 또는 mechanism-linked PD/biomarker를 확인하지 못했습니다.",
        "investigation_note": "dedicated drug page의 target/action/mechanism을 확인했습니다.",
        "uncertain_points": [
          "No asset-specific mechanistic validation identified"
        ],
        "source_ids": [
      ...
      "data_maturity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "확인된 공개 결과가 없어 Data 0입니다.",
        "evidence_basis": "public_source",
        "main_line_summary": "Data 0 points: dedicated public drug page에서 AXN-1901의 clinical result가 No Data로 표시되며 별도 asset-specific 결과를 확인하지 못했습니다.",
        "why_not_higher": "해석 가능한 공개 asset-specific 결과가 없습니다.",
        "investigation_note": "공개 dedicated drug record를 확인했습니다.",
        "uncertain_points": [
          "No public asset-specific result identified"
        ],
        "source_ids": [
    ...
    "source_registry": [
      {
        ...
        "source_title": "Synapse - Axceso Biopharma Co. Ltd. pipeline",
        "source_url": "https://synapse.patsnap.com/organization/9e5e4b40b472ceabb19a88c37b5340f0",
        "source_type": "biopharma intelligence database",
        "verified": true
      },
      {
        "source_id": "S2",
        "source_title": "Synapse - AXN-1901",
        "source_url": "https://synapse.patsnap.com/drug/018ac73cccde49b297c26ece067c08df",
        "source_type": "biopharma intelligence database",
        "verified": true
      }
    ]
  ...
  "final_insight": {
    "one_line_summary": "AXN-1901은 Parkinson/SIRT1 asset identity는 확인되지만 최신 snapshot에서 discontinued이므로 REJECT입니다.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "2026-08 이후 AXN-1901 재활성화를 보여주는 공식 근거가 있는가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "AXN-1901은 SIRT1 stimulant Parkinson program으로 identity는 확인됩니다. 오래된 dedicated page는 preclinical active로 보이지만 더 최신 current-project snapshot이 Discontinued이므로 REJECT입니다.",
    "missing_evidence_needed_for_full_scout": [
      "프로그램 재활성화 또는 새로운 개발주체를 보여주는 더 최신 공식 근거"
    ]
  }
}
```
