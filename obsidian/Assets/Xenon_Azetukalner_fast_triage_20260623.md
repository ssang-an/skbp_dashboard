...
Strong same-target Kv7 benchmark; run Full Scout.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | Kv7/KCNQ is a direct E/I Balance ion-channel target. |  | Xenon Announces Positive Topline Data from Phase 3 X-TOLE2 Study (https://investor.xenon-pharma.com/news-releases/news-release-details/xenon-announces-positive-topline-data-phase-3-x-tole2-study) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | Kv7/KCNQ opening has visible clinical validation in FOS. |  | JAMA Neurology XEN1101 Phase 2b trial (https://jamanetwork.com/journals/jamaneurology/fullarticle/2809938) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 3 positive topline and Phase 2b publication are visible. |  | Xenon Announces Positive Topline Data from Phase 3 X-TOLE2 Study (https://investor.xenon-pharma.com/news-releases/news-release-details/xenon-announces-positive-topline-data-phase-3-x-tole2-study)<br>JAMA Neurology XEN1101 Phase 2b trial (https://jamanetwork.com/journals/jamaneurology/fullarticle/2809938) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | Kv7/KCNQ is a direct E/I Balance ion-channel target. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| Xenon Announces Positive Topline Data from Phase 3 X-TOLE2 Study | official_company | high | - | Phase 3 X-TOLE2 positive topline data in focal onset seizures. | https://investor.xenon-pharma.com/news-releases/news-release-details/xenon-announces-positive-topline-data-phase-3-x-tole2-study |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Kv7/KCNQ opening has visible clinical validation in FOS. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Source | Type | Reliability | Supports Score | Evidence Summary | URL |
|---|---|---|---|---|---|
| JAMA Neurology XEN1101 Phase 2b trial | publication | high | - | Randomized Phase 2b evidence for XEN1101 in focal-onset seizures. | https://jamanetwork.com/journals/jamaneurology/fullarticle/2809938 |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Phase 3 positive topline and Phase 2b publication are visible. |
| Why Not Higher |  |
| Investigation Note |  |
...
- Azetukalner/XEN1101 is a clinical Kv7/KCNQ opener for focal onset seizures.
- Phase 3 positive topline and Phase 2b publication are publicly visible.

### Uncertain Points

- Full registrational package not assessed in fast triage.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Ion Channel|Ion Channel]]
- Dashboard record id: `Xenon_Azetukalner_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "human_review": {
      ...
      "history": [
        ...
        {
          "changed_at": "2026-08-22T15:13:54.448100+00:00",
          "actor_ip": "127.0.0.1",
          "actor_name": "정주원",
          "source": "dashboard_table",
          "field": "final_comment",
        ...
        {
          "changed_at": "2026-08-22T15:16:02.946748+00:00",
          "actor_ip": "127.0.0.1",
          "actor_name": "정주원",
          "source": "detail_final_comment_delete",
          "field": "final_comment",
      ...
      "last_updated_at": "2026-08-22T15:16:02.946748+00:00",
    ...
    "edit_history": [
      ...
      {
        "id": "8915ea5cfc2d49238be72117daffa899",
        "changed_at": "2026-08-22T15:13:54.448133+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "정주원",
        "source": "dashboard_table_manual_review",
        "field": "final_comment",
      ...
      {
        "id": "2728df3a81eb47928c9e69074e9569f1",
        "changed_at": "2026-08-22T15:14:12.012100+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "",
      ...
      {
        "id": "95bd6e667762491ba3ea9934ff8d3afc",
        "changed_at": "2026-08-22T15:16:02.946782+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "정주원",
        "source": "detail_final_comment_delete",
        "field": "final_comment",
  ...
  "input": {
    "company_input": "Xenon Pharmaceuticals",
    "asset_input": "Azetukalner / XEN1101"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Ion Channel",
    "target_description": "Kv7/KCNQ is a direct E/I Balance ion-channel target."
  },
  "structured_table": {
    "company": "Xenon Pharmaceuticals",
    ...
    "sources": [
      {
        "source_title": "Xenon Announces Positive Topline Data from Phase 3 X-TOLE2 Study",
  ...
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and TR/MOA/Data are all >=2; strong same-target benchmark for NS-041.",
    "flags": [
      "fast_triage_only",
      "same_target_benchmark",
      "phase_3_data_visible"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "Kv7/KCNQ is a direct E/I Balance ion-channel target.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Kv7/KCNQ opening has visible clinical validation in FOS.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Phase 3 positive topline and Phase 2b publication are visible.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
    ...
    "source_registry": [
      {
        ...
        "reliability": "high",
        "evidence_summary": "Phase 3 X-TOLE2 positive topline data in focal onset seizures."
      },
      {
        "source_id": "SRC_b8b204beb4ab",
        "source_title": "JAMA Neurology XEN1101 Phase 2b trial",
        "source_url": "https://jamanetwork.com/journals/jamaneurology/fullarticle/2809938",
        "source_type": "publication",
        "reliability": "high",
        "evidence_summary": "Randomized Phase 2b evidence for XEN1101 in focal-onset seizures."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "Strong same-target Kv7 benchmark; run Full Scout.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "How does azetukalner's efficacy and safety profile define the bar for NS-041 differentiation?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Kv7/KCNQ target relevance, MoA clinical plausibility, and Phase 3/Phase 2 evidence are all strong enough for Full Scout.",
    "missing_evidence_needed_for_full_scout": [
      "Full Phase 3 X-TOLE2 dataset",
      "NDA filing status",
      "safety differentiation versus retigabine and other Kv7 openers"
    ]
  }
}
```
