...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | Kv7/KCNQ is a direct E/I Balance ion-channel target. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | Kv7/KCNQ opening has visible clinical validation in FOS. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 3 positive topline and Phase 2b publication are visible. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #1"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "NS-041과 동일 Kv7/KCNQ 축의 가장 강한 임상 benchmark로 Phase 3 FOS positive topline과 publication evidence가 있어 Full Scout 우선순위가 높다.",
