...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | SCN1A/Nav1.1 loss is directly linked to Dravet E/I imbalance. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | ASO-mediated SCN1A productive mRNA increase is a clear disease-modifying rationale. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 3 EMPEROR is active with prior clinical studies and public data signals. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #7"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "Dravet syndrome의 genetic root cause를 겨냥하는 ASO로 Phase 3 및 clinical data가 확인되어 Full Scout 가치가 매우 높다.",
  ...
  "scoring": {
    ...
    "criteria": {
      "target_relevance": {
        ...
        "evidence_sources": [
          "https://www.stoketherapeutics.com/patients-families/clinical-studies/"
        ],
        "uncertain_points": []
      },
      "moa_validity": {
