...
asset: "Zorevunersen / STK-001"
target: "SCN1A / Nav1.1 expression restoration"
theme: "E/I Balance"
cluster: "Ion Channel"
stage: "Phase 3"
total_score: null
...
High-priority Dravet disease-modifying ASO; run Full Scout.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | SCN1A/Nav1.1 loss is directly linked to Dravet E/I imbalance. |  | Stoke Clinical Studies (https://www.stoketherapeutics.com/patients-families/clinical-studies/) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | ASO-mediated SCN1A productive mRNA increase is a clear disease-modifying rationale. |  | Stoke Clinical Studies (https://www.stoketherapeutics.com/patients-families/clinical-studies/) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 3 EMPEROR is active with prior clinical studies and public data signals. |  | Stoke Phase 3 EMPEROR timeline update (https://investor.stoketherapeutics.com/news-releases/news-release-details/stoke-therapeutics-announces-updates-timelines-completion) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | SCN1A/Nav1.1 loss is directly linked to Dravet E/I imbalance. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| Stoke Clinical Studies | official_company | high | - | EMPEROR Phase 3 study and prior MONARCH/ADMIRAL/OLE studies described. | https://www.stoketherapeutics.com/patients-families/clinical-studies/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | ASO-mediated SCN1A productive mRNA increase is a clear disease-modifying rationale. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Phase 3 EMPEROR is active with prior clinical studies and public data signals. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Phase 3 outcome not yet available.
...
| Source | Type | Reliability | Supports Score | Evidence Summary | URL |
|---|---|---|---|---|---|
| Stoke Phase 3 EMPEROR timeline update | official_company | high | - | Phase 3 EMPEROR enrollment and readout timeline for zorevunersen. | https://investor.stoketherapeutics.com/news-releases/news-release-details/stoke-therapeutics-announces-updates-timelines-completion |
...
- Zorevunersen/STK-001 is an ASO for Dravet syndrome targeting SCN1A expression.
- Phase 3 EMPEROR study is publicly described.

### Uncertain Points

- Fast triage did not review full primary literature or detailed safety tables.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Ion Channel|Ion Channel]]
- Dashboard record id: `Stoke_Zorevunersen_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Stoke_Zorevunersen_fast_triage_20260623",
  ...
  "input": {
    "company_input": "Stoke Therapeutics / Biogen",
    "asset_input": "Zorevunersen / STK-001"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Ion Channel",
    "target_description": "SCN1A/Nav1.1 loss is directly linked to Dravet E/I imbalance."
  },
  "structured_table": {
    "company": "Stoke Therapeutics / Biogen",
    "asset_name": "Zorevunersen / STK-001",
    "target": "SCN1A / Nav1.1 expression restoration",
    "moa": "ASO intended to increase productive SCN1A mRNA and Nav1.1 protein expression",
    "modality_platform": "Antisense oligonucleotide",
    ...
    "sources": [
      {
        "source_title": "Stoke Phase 3 EMPEROR timeline update",
        "source_url": "https://investor.stoketherapeutics.com/news-releases/news-release-details/stoke-therapeutics-announces-updates-timelines-completion"
      }
    ]
  },
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and TR/MOA/Data are all >=2; disease-modifying genetic epilepsy asset in Phase 3.",
    "flags": [
      "fast_triage_only",
      "phase_3",
      "disease_modifying_aso"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "SCN1A/Nav1.1 loss is directly linked to Dravet E/I imbalance.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "ASO-mediated SCN1A productive mRNA increase is a clear disease-modifying rationale.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Phase 3 EMPEROR is active with prior clinical studies and public data signals.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Phase 3 outcome not yet available."
  ...
  "validation": {
    ...
    "source_registry": [
      {
        "source_id": "SRC_4b6ac9d5ba50",
        "source_title": "Stoke Phase 3 EMPEROR timeline update",
        "source_url": "https://investor.stoketherapeutics.com/news-releases/news-release-details/stoke-therapeutics-announces-updates-timelines-completion",
        "source_type": "official_company",
        "reliability": "high",
        "evidence_summary": "Phase 3 EMPEROR enrollment and readout timeline for zorevunersen."
      },
      {
        "source_id": "SRC_bf8894e6369e",
        "source_title": "Stoke Clinical Studies",
        "source_url": "https://www.stoketherapeutics.com/patients-families/clinical-studies/",
        "source_type": "official_company",
        "reliability": "high",
        "evidence_summary": "EMPEROR Phase 3 study and prior MONARCH/ADMIRAL/OLE studies described."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "High-priority Dravet disease-modifying ASO; run Full Scout.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "Does zorevunersen's disease-modifying efficacy justify intrathecal treatment burden and support expansion beyond Dravet?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Root-cause ASO for SCN1A Dravet syndrome with Phase 3 development and visible clinical evidence.",
    "missing_evidence_needed_for_full_scout": [
      "Full NEJM/clinical dataset review",
      "Phase 3 EMPEROR endpoint and enrollment status",
      "Dose durability and intrathecal administration burden",
      "Commercial rights with Biogen"
    ]
  }
}
```
