...
| Rubric Definition | - |
| Judgment Reason | TR 0 points: AZBE53206의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다. |
| Why Not Higher | 정확한 asset identity와 적응증이 먼저 확인되어야 합니다. |
| Investigation Note | AZothBio current-project snapshot을 확인했습니다. |
...
| Rubric Definition | - |
| Judgment Reason | MOA 0 points: AZBE53206의 target 또는 MoA를 확인하지 못했습니다. |
| Why Not Higher | 기전 description이나 functional validation을 평가할 asset-specific 근거가 없습니다. |
| Investigation Note | 정확한 asset identity 확인이 선행되어야 합니다. |
...
| Rubric Definition | - |
| Judgment Reason | Data 0 points: AZBE53206에 대한 공개 asset-specific 결과를 확인하지 못했습니다. |
| Why Not Higher | 해석 가능한 정량 결과가 없습니다. |
| Investigation Note | 정확한 asset identity 확인 후 데이터 검색이 필요합니다. |
...
- AZothBio current projects list AZB101 and AZB102, not AZBE53206.
- AZothBio is located in Gyeonggi-do, South Korea.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `AZothBio_AZBE53206`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "AZothBio_AZBE53206",
  ...
  "input": {
    "company_input": "AZothBio",
    "asset_input": "AZBE53206"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "TR 0 points: AZBE53206의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다."
  },
  "structured_table": {
    "company": "AZothBio",
    "asset_name": "AZBE53206",
    "target": "Unknown",
    "moa": "Unknown",
    ...
    "sources": [
      {
        "source_title": "Synapse - AZothBio Inc. pipeline",
        "source_url": "https://synapse.patsnap.com/organization/8e13cd3c07e71715c6da726e023d66ee"
      }
    ]
  },
  "hard_filter": {
    "status": "UNVERIFIED",
    "reason": "AZothBio의 current-project snapshot에서 AZB101/AZB102는 확인되지만 AZBE53206이라는 정확한 asset identifier를 확인하지 못했습니다.",
    "flags": [
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "정확한 asset identity가 미확인되어 TR 판단 근거가 없습니다.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "TR 0 points: AZBE53206의 적응증 및 target/MoA를 asset-specific하게 확인하지 못했습니다.",
        "why_not_higher": "정확한 asset identity와 적응증이 먼저 확인되어야 합니다.",
        "investigation_note": "AZothBio current-project snapshot을 확인했습니다.",
        "uncertain_points": [
          "AZBE53206 exact identity unresolved"
        ],
        "source_ids": []
      ...
      "moa_validity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "정확한 asset identity가 미확인되어 MoA 근거가 없습니다.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "MOA 0 points: AZBE53206의 target 또는 MoA를 확인하지 못했습니다.",
        "why_not_higher": "기전 description이나 functional validation을 평가할 asset-specific 근거가 없습니다.",
        "investigation_note": "정확한 asset identity 확인이 선행되어야 합니다.",
        "uncertain_points": [
          "Target/MoA unknown"
        ],
        "source_ids": []
      ...
      "data_maturity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "정확한 asset identity가 미확인되어 데이터 근거가 없습니다.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "Data 0 points: AZBE53206에 대한 공개 asset-specific 결과를 확인하지 못했습니다.",
        "why_not_higher": "해석 가능한 정량 결과가 없습니다.",
        "investigation_note": "정확한 asset identity 확인 후 데이터 검색이 필요합니다.",
        "uncertain_points": [
          "Asset-specific data unknown"
        ],
        "source_ids": []
  ...
  "final_insight": {
    "one_line_summary": "AZBE53206은 AZothBio의 정확한 pipeline asset으로 공개 검증되지 않아 UNVERIFIED입니다.",
    "recommendation": "Verify asset identity",
    "most_important_diligence_question": "AZBE53206의 원문 출처 또는 공식 alias를 확보할 수 있는가?"
  },
  "triage": {
    "status": "UNVERIFIED",
    ...
    "why": "회사 identity와 다른 pipeline assets는 확인되지만 AZBE53206 자체를 특정 biotech/pharma pipeline asset으로 검증할 수 없어 UNVERIFIED입니다.",
    "missing_evidence_needed_for_full_scout": [
      "AZBE53206의 공식 명칭/alias 또는 원출처",
      "AZothBio와 AZBE53206을 직접 연결하는 공식 pipeline, 발표자료, 특허 또는 registry 근거"
    ]
  }
}
```
