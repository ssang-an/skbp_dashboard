...
| Stage | Phase 1 |
| Indication | DEE planning; ALS hyperexcitability clinical PoM context |
...
Early but relevant Kv7.2/7.3 opener; run Full Scout if prioritizing class map.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | Kv7.2/Kv7.3 is a strong E/I Balance ion-channel target. |  | QurAlis Phase 1 QRL-101 AES 2025 announcement (https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 2 | triage_only | - | Kv7.2/7.3 opening is plausible and class-validated, but QRL-101 epilepsy efficacy is not yet mature. |  | QurAlis Phase 1 QRL-101 AES 2025 announcement (https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 2 | triage_only | - | Phase 1 data and DEE Phase 2 planning are enough for triage selection. |  | QurAlis Phase 1 QRL-101 AES 2025 announcement (https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | Kv7.2/Kv7.3 is a strong E/I Balance ion-channel target. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| QurAlis Phase 1 QRL-101 AES 2025 announcement | official_company | high | - | QRL-101 is described as a selective Kv7.2/7.3 opener with Phase 1 data and planned Phase 2 in DEE. | https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Kv7.2/7.3 opening is plausible and class-validated, but QRL-101 epilepsy efficacy is not yet mature. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Epilepsy-specific efficacy evidence is not yet visible.
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Phase 1 data and DEE Phase 2 planning are enough for triage selection. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Clinical efficacy data in DEE not yet verified.
...
- QRL-101 is publicly described as a selective Kv7.2/7.3 opener.
- Phase 1 clinical data and DEE Phase 2 planning are publicly described.

### Uncertain Points

- Main clinical focus includes ALS hyperexcitability; epilepsy-specific stage should be verified before Full Scout.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Ion Channel|Ion Channel]]
- Dashboard record id: `QurAlis_QRL-101_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "QurAlis_QRL-101_fast_triage_20260623",
  ...
  "input": {
    "company_input": "QurAlis",
    "asset_input": "QRL-101"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Ion Channel",
    "target_description": "Kv7.2/Kv7.3 is a strong E/I Balance ion-channel target."
  },
  "structured_table": {
    "company": "QurAlis",
    "asset_name": "QRL-101",
    "target": "Kv7.2/Kv7.3",
    "moa": "Selective Kv7.2/Kv7.3 ion-channel opener intended to reduce neuronal hyperexcitability",
    ...
    "sources": [
      {
        "source_title": "QurAlis Phase 1 QRL-101 AES 2025 announcement",
        "source_url": "https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/"
      }
    ]
  },
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and TR/MOA are >=2; Data is adequate for triage but lower than later-stage assets.",
    "flags": [
      "fast_triage_only",
      "early_clinical",
      "epilepsy_stage_uncertainty"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "Kv7.2/Kv7.3 is a strong E/I Balance ion-channel target.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Kv7.2/7.3 opening is plausible and class-validated, but QRL-101 epilepsy efficacy is not yet mature.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Epilepsy-specific efficacy evidence is not yet visible."
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Phase 1 data and DEE Phase 2 planning are enough for triage selection.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Clinical efficacy data in DEE not yet verified."
  ...
  "validation": {
    ...
    "source_registry": [
      {
        "source_id": "SRC_928df6669066",
        "source_title": "QurAlis Phase 1 QRL-101 AES 2025 announcement",
        "source_url": "https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/",
        "source_type": "official_company",
        "reliability": "high",
        "evidence_summary": "QRL-101 is described as a selective Kv7.2/7.3 opener with Phase 1 data and planned Phase 2 in DEE."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "Early but relevant Kv7.2/7.3 opener; run Full Scout if prioritizing class map.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "Is QRL-101 meaningfully differentiated from other Kv7.2/7.3 openers in potency, tolerability, or disease positioning?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Kv7.2/7.3 target relevance is strong and Phase 1/target-engagement evidence supports quick review progression.",
    "missing_evidence_needed_for_full_scout": [
      "DEE Phase 2 protocol/status",
      "Epilepsy-specific patient efficacy data",
      "Quantitative selectivity and safety comparison to NS-041/BHV-7000/XEN1101"
    ]
  }
}
```
