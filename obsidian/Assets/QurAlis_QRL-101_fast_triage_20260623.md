...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | Kv7.2/Kv7.3 is a strong E/I Balance ion-channel target. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 2 | triage_only | - | Kv7.2/7.3 opening is plausible and class-validated, but QRL-101 epilepsy efficacy is not yet mature. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 2 | triage_only | - | Phase 1 data and DEE Phase 2 planning are enough for triage selection. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #3"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "Selective Kv7.2/7.3 opener로 NS-041 class 비교 가치가 있으나 epilepsy patient efficacy는 아직 제한적이다.",
  ...
  "scoring": {
    ...
    "criteria": {
      "target_relevance": {
        ...
        "evidence_sources": [
          "https://www.quralis.com/news/quralis-to-present-data-from-its-phase-1-clinical-trial-of-qrl-101-a-potential-best-in-class-selective-kv7-2-7-3-ion-channel-opener-at-american-epilepsy-society-2025-annual-meeting/"
        ],
        "uncertain_points": []
      },
      "moa_validity": {
