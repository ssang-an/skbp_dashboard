...
|---|---:|---|---|---|---|---|
| Target Relevance | 2 | triage_only | - | TR 2 points: Alzheimer's dementia는 관심 적응증이나 molecular target/MoA는 미확인이다. | TR 3에 필요한 직접 target/MoA 연결이 없다. | Korea Pharma Research Results (https://koreapharma.co.kr/eng/sub_research/result.php) |
...
| Rubric Definition | - |
| Judgment Reason | TR 2 points: Alzheimer's dementia는 관심 적응증이나 molecular target/MoA는 미확인이다. |
...
- 공식 R&D: KP 102/Alzheimer's dementia.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Korea Pharma Co Ltd_KP-102`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Korea Pharma Co Ltd_KP-102",
  ...
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Alzheimer's dementia project; target/MoA undisclosed."
  },
  "structured_table": {
    "company": "Korea Pharma Co Ltd",
    "asset_name": "KP-102",
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "TR 2 points: Alzheimer's dementia는 관심 적응증이나 molecular target/MoA는 미확인이다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 2 points: Alzheimer's dementia는 관심 적응증이나 molecular target/MoA는 미확인이다.",
  ...
  "final_insight": {
    ...
    "most_important_diligence_question": "Target/MoA와 정량 asset-specific 데이터는 무엇인가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "Alzheimer's dementia fit은 확인되나 target/MoA/정량 결과가 없어 REJECT다.",
