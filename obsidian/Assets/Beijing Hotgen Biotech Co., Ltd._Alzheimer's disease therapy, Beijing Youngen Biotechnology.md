...
record_id: "Beijing Hotgen Biotech Co., Ltd._Alzheimer's disease therapy, Beijing Youngen Biotechnology"
company: "Beijing Hotgen Biotech Co., Ltd."
country: "China"
...
| Rubric Definition | - |
| Judgment Reason | TR 0점: 특정 자산의 적응증으로 귀속할 수 없습니다. |
| Why Not Higher | 자산 identity가 먼저 확정돼야 합니다. |
| Investigation Note | Youngen APP-siRNA와 Hotgen 계열 AA001을 각각 확인했습니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 0점: 특정 자산의 표적·기전을 확정할 수 없습니다. |
| Why Not Higher | APP-siRNA와 Aβ 항체는 서로 다른 프로그램입니다. |
| Investigation Note | 입력 행의 회사·프로그램 조합을 해소해야 합니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 0점: 평가 대상 자산 자체가 정해지지 않았습니다. |
| Why Not Higher | 후보별 데이터는 현재 행에 귀속할 수 없습니다. |
| Investigation Note | 정확한 자산 식별자가 필요합니다. |
...
- Youngen의 APP-siRNA 특허 프로그램
- Hotgen 투자계열 AA001 존재
- 입력 회사·자산 불일치
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Beijing Hotgen Biotech Co., Ltd._Alzheimer's disease therapy, Beijing Youngen Biotechnology`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Beijing Hotgen Biotech Co., Ltd._Alzheimer's disease therapy, Beijing Youngen Biotechnology",
  ...
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Youngen APP-siRNA와 Hotgen 계열 AA001 중 어느 자산인지 식별되지 않음."
  },
  "structured_table": {
    "company": "Beijing Hotgen Biotech Co., Ltd.",
  ...
  "hard_filter": {
    "status": "UNVERIFIED",
    "reason": "특정 biotech/pharma asset identity를 확인할 수 없습니다.",
    "flags": [
      "company_asset_mismatch",
      "multiple_possible_assets"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "main_line_summary": "TR 0점: 특정 자산의 적응증으로 귀속할 수 없습니다.",
        "why_not_higher": "자산 identity가 먼저 확정돼야 합니다.",
        "investigation_note": "Youngen APP-siRNA와 Hotgen 계열 AA001을 각각 확인했습니다.",
        "uncertain_points": [
          "후보 자산 2개가 충돌"
        ],
        "source_ids": []
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "MOA 0점: 특정 자산의 표적·기전을 확정할 수 없습니다.",
        "why_not_higher": "APP-siRNA와 Aβ 항체는 서로 다른 프로그램입니다.",
        "investigation_note": "입력 행의 회사·프로그램 조합을 해소해야 합니다.",
        "uncertain_points": [
          "프로그램 혼합"
        ],
        "source_ids": []
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "Data 0점: 평가 대상 자산 자체가 정해지지 않았습니다.",
        "why_not_higher": "후보별 데이터는 현재 행에 귀속할 수 없습니다.",
        "investigation_note": "정확한 자산 식별자가 필요합니다.",
        "uncertain_points": [],
        "source_ids": []
      }
    },
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "YH2",
        "source_title": "Hotgen announcement on AA001 IND approval",
        "source_url": "https://www.hotgen.com.cn/detail/683.html",
        "source_type": "official_company_news",
        "verified": true
      }
    ]
  ...
  "final_insight": {
    "one_line_summary": "서로 다른 두 AD 프로그램이 혼합된 입력으로 자산 신원 확인이 우선입니다.",
    "recommendation": "Verify asset identity",
    "most_important_diligence_question": "이 행은 Youngen APP-siRNA와 AA001 중 어느 자산을 의미하는가?"
  },
  "triage": {
    "status": "UNVERIFIED",
    ...
    "why": "입력 자산명이 Youngen의 무코드 APP-siRNA와 Hotgen 투자계열의 AA001을 혼합해 특정 자산으로 매핑할 수 없습니다.",
