...
record_id: "Illimis Therapeutics_ILM21"
...
UNVERIFIED: ILM21 is not a verified public asset.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 0 | triage_only | - | TR 0점: No verified ILM21 indication. |  | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0점: No verified ILM21 mechanism. |  | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0점: No verified ILM21 result. |  | - |
| Marketability | - | - | - | - | - | - |
...
| Evidence Type Reason | TR 0점: No verified ILM21 indication. |
| Rubric Definition | - |
| Judgment Reason | TR 0점: No verified ILM21 indication. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Score | 0 |
| Evidence Type | triage_only |
| Evidence Type Reason | MOA 0점: No verified ILM21 mechanism. |
| Rubric Definition | - |
| Judgment Reason | MOA 0점: No verified ILM21 mechanism. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Score | 0 |
| Evidence Type | triage_only |
| Evidence Type Reason | Data 0점: No verified ILM21 result. |
| Rubric Definition | - |
| Judgment Reason | Data 0점: No verified ILM21 result. |
| Why Not Higher |  |
| Investigation Note |  |
...
- Current public pipeline lists ILM01/02/03.

### Uncertain Points

- Could be a typo or internal construct.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Illimis Therapeutics_ILM21`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Illimis Therapeutics_ILM21",
  ...
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "TR 0점: No verified ILM21 indication."
  },
  "structured_table": {
    "company": "Illimis Therapeutics",
    "asset_name": "ILM21",
  ...
  "hard_filter": {
    "status": "UNVERIFIED",
    "reason": "No public Illimis asset named ILM21 was found.",
    "flags": [
      "identity_not_verified",
      "possible_typo_or_internal_code"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "TR 0점: No verified ILM21 indication.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "TR 0점: No verified ILM21 indication.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": []
      ...
      "moa_validity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "MOA 0점: No verified ILM21 mechanism.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "MOA 0점: No verified ILM21 mechanism.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": []
      ...
      "data_maturity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "Data 0점: No verified ILM21 result.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "Data 0점: No verified ILM21 result.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": []
    ...
    "source_registry": [
      {
        ...
        "evidence_summary": "No ILM21 listing.",
        "verified": true
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "UNVERIFIED: ILM21 is not a verified public asset.",
    "recommendation": "Verify asset identity",
    "most_important_diligence_question": "Is ILM21 a typo for ILM01, ILM02 or ILM03?"
  },
  "triage": {
    "status": "UNVERIFIED",
    ...
    "why": "Public pipeline lists ILM01, ILM02 and ILM03, not ILM21.",
    "missing_evidence_needed_for_full_scout": [
      "Correct code",
      "Source, target, indication and stage"
    ]
  }
}
```
