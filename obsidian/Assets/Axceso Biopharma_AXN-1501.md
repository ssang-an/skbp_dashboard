...
record_id: "Axceso Biopharma_AXN-1501"
...
|---|---:|---|---|---|---|---|
| Target Relevance | 2 | triage_only | - | TR 2 points: AXN-1501의 indication은 Alzheimer disease로 확인되어 SKBP interest indication에 해당합니다. | SIRT1 mechanism이 이 asset의 Alzheimer disease biology와 직접 연결된 검증 근거는 quick triage에서 확인하지 못했습니다. | Synapse - Axceso Biopharma Co. Ltd. pipeline (https://synapse.patsnap.com/organization/9e5e4b40b472ceabb19a88c37b5340f0)<br>Synapse - AXN-1501 (https://synapse.patsnap.com/drug/237c58bbaef74d41827f938aad50a873) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 1 | triage_only | - | MOA 1 points: AXN-1501은 SIRT1 stimulant로 기술됩니다. | asset-specific functional evidence, target engagement 또는 mechanism-linked PD/biomarker를 확인하지 못했습니다. | Synapse - AXN-1501 (https://synapse.patsnap.com/drug/237c58bbaef74d41827f938aad50a873) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: dedicated public drug page에서 AXN-1501의 clinical result가 No Data로 표시되며 별도 asset-specific 결과를 확인하지 못했습니다. | 해석 가능한 공개 asset-specific 결과가 없습니다. | Synapse - AXN-1501 (https://synapse.patsnap.com/drug/237c58bbaef74d41827f938aad50a873) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 2 points: AXN-1501의 indication은 Alzheimer disease로 확인되어 SKBP interest indication에 해당합니다. |
| Why Not Higher | SIRT1 mechanism이 이 asset의 Alzheimer disease biology와 직접 연결된 검증 근거는 quick triage에서 확인하지 못했습니다. |
| Investigation Note | indication과 target를 공개 drug/pipeline source에서 확인했습니다. |
...
| Synapse - AXN-1501 | biopharma intelligence database | - | - | - | https://synapse.patsnap.com/drug/237c58bbaef74d41827f938aad50a873 |
...
| Rubric Definition | - |
| Judgment Reason | MOA 1 points: AXN-1501은 SIRT1 stimulant로 기술됩니다. |
...
| Rubric Definition | - |
| Judgment Reason | Data 0 points: dedicated public drug page에서 AXN-1501의 clinical result가 No Data로 표시되며 별도 asset-specific 결과를 확인하지 못했습니다. |
...
- Axceso current pipeline snapshot lists AXN-1501 (SIRT1), Alzheimer Disease, Discontinued.
- Dedicated AXN-1501 page lists small molecule, SIRT1 stimulant, inactive Alzheimer indication, and discontinued preclinical status.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Axceso Biopharma_AXN-1501`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Axceso Biopharma_AXN-1501",
  ...
  "input": {
    ...
    "asset_input": "AXN-1501"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Small-molecule SIRT1 stimulant program previously associated with Alzheimer disease."
  },
  "structured_table": {
    "company": "Axceso Biopharma",
    "asset_name": "AXN-1501",
  ...
  "hard_filter": {
    "status": "REJECT",
    "reason": "최신 current-project snapshot과 dedicated drug page에서 AXN-1501이 discontinued/inactive로 확인되어 lifecycle hard blocker가 적용됩니다.",
    "flags": [
      "inactive_asset",
      "discontinued"
    ],
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "Alzheimer disease 적응증은 검증되지만 TR 3에 필요한 직접 biology linkage는 확인되지 않았습니다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 2 points: AXN-1501의 indication은 Alzheimer disease로 확인되어 SKBP interest indication에 해당합니다.",
        "why_not_higher": "SIRT1 mechanism이 이 asset의 Alzheimer disease biology와 직접 연결된 검증 근거는 quick triage에서 확인하지 못했습니다.",
        "investigation_note": "indication과 target를 공개 drug/pipeline source에서 확인했습니다.",
        "uncertain_points": [
          "Direct asset-specific disease-biology linkage not established"
        ],
        "source_ids": [
      ...
      "moa_validity": {
        "score": 1,
        "evidence_type": "triage_only",
        "evidence_type_reason": "기전 description은 확인되지만 검증 수준은 회사/DB description을 넘지 못합니다.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 1 points: AXN-1501은 SIRT1 stimulant로 기술됩니다.",
      ...
      "data_maturity": {
        ...
        "evidence_basis": "public_source",
        "main_line_summary": "Data 0 points: dedicated public drug page에서 AXN-1501의 clinical result가 No Data로 표시되며 별도 asset-specific 결과를 확인하지 못했습니다.",
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "S2",
        "source_title": "Synapse - AXN-1501",
        "source_url": "https://synapse.patsnap.com/drug/237c58bbaef74d41827f938aad50a873",
        "source_type": "biopharma intelligence database",
        "verified": true
      }
    ]
  ...
  "final_insight": {
    "one_line_summary": "AXN-1501은 Alzheimer/SIRT1 asset identity는 확인되지만 discontinued이므로 REJECT입니다.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "공식적으로 프로그램이 재활성화되었거나 권리가 이전되었다는 최신 근거가 있는가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "AXN-1501은 SIRT1 stimulant Alzheimer program으로 identity는 확인되지만 현재 discontinued/inactive이므로 Full Scout 우선순위에서 제외합니다.",
    "missing_evidence_needed_for_full_scout": [
      "프로그램 재활성화 또는 새로운 개발주체가 확인되는 공식 최신 근거"
    ]
  }
}
```
