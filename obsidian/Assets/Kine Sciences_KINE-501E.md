...
record_id: "Kine Sciences_KINE-501E"
company: "Kine Sciences"
country: "Republic of Korea"
asset: "KINE-501E"
target: "Microglia (target cell); molecular target Unknown"
theme: "Unknown"
cluster: "Unknown"
...
|---|---:|---|---|---|---|---|
| Target Relevance | 2 | triage_only | - | TR 2 points: Multiple sclerosis는 관심 적응증이나 molecular target/MoA는 미확인이다. | TR 3에 필요한 직접 target/MoA 연결이 없다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501E (https://synapse.patsnap.com/drug/7673acce77814a54b56af0c67e6eb23a) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다. | 확인된 기전이 없다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501E (https://synapse.patsnap.com/drug/7673acce77814a54b56af0c67e6eb23a) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다. | Preclinical 상태 자체는 결과가 아니다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501E (https://synapse.patsnap.com/drug/7673acce77814a54b56af0c67e6eb23a) |
| Marketability | - | - | - | - | - | - |
...
| Evidence Type Reason | TR 2 points: Multiple sclerosis는 관심 적응증이나 molecular target/MoA는 미확인이다. |
| Rubric Definition | - |
| Judgment Reason | TR 2 points: Multiple sclerosis는 관심 적응증이나 molecular target/MoA는 미확인이다. |
...
|---|---|---|---|---|---|
| Kine Sciences Pipeline | official_company_pipeline | - | - | - | https://www.kinesciences.com/m31.php |
| Synapse: KINE-501E | biopharma_database | - | - | - | https://synapse.patsnap.com/drug/7673acce77814a54b56af0c67e6eb23a |
...
| Score | 0 |
| Evidence Type | triage_only |
| Evidence Type Reason | MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다. |
| Rubric Definition | - |
| Judgment Reason | MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다. |
| Why Not Higher | 확인된 기전이 없다. |
| Investigation Note |  |
...
| Rubric Definition | - |
| Judgment Reason | Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다. |
| Why Not Higher | Preclinical 상태 자체는 결과가 아니다. |
| Investigation Note |  |
...
- 공식 pipeline: KINE-501E/MS/Microglial.
- Synapse: Preclinical; drug type은 generic Chemical drugs.

### Uncertain Points

- Molecular target/MoA 미확인.
- 정량 결과 미확인.
- Canonical modality 미확정.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Kine Sciences_KINE-501E`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Kine Sciences_KINE-501E",
  ...
  "input": {
    "company_input": "Kine Sciences",
    "asset_input": "KINE-501E"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Multiple sclerosis program; Target Cell=Microglial, molecular target undisclosed."
  },
  "structured_table": {
    "company": "Kine Sciences",
    "asset_name": "KINE-501E",
    "target": "Microglia (target cell); molecular target Unknown",
    "moa": "Unknown",
    ...
    "sources": [
      {
        "source_title": "Kine Sciences Pipeline",
        "source_url": "https://www.kinesciences.com/m31.php"
      }
    ]
  },
  "hard_filter": {
    "status": "REJECT",
    "reason": "관심 적응증은 확인되지만 공개 MoA/Data가 SELECT 기준에 못 미친다.",
    "flags": [
      "insufficient_moa_or_data"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "TR 2 points: Multiple sclerosis는 관심 적응증이나 molecular target/MoA는 미확인이다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 2 points: Multiple sclerosis는 관심 적응증이나 molecular target/MoA는 미확인이다.",
        "why_not_higher": "TR 3에 필요한 직접 target/MoA 연결이 없다.",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
          "S1",
      ...
      "moa_validity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다.",
        "why_not_higher": "확인된 기전이 없다.",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
          "S1",
      ...
      "data_maturity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다.",
        "evidence_basis": "public_source",
        "main_line_summary": "Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다.",
        "why_not_higher": "Preclinical 상태 자체는 결과가 아니다.",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
          "S1",
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "S2",
        "source_title": "Synapse: KINE-501E",
        "source_url": "https://synapse.patsnap.com/drug/7673acce77814a54b56af0c67e6eb23a",
  ...
  "final_insight": {
    "one_line_summary": "TR 2이나 공개 MoA/Data가 부족하다.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "Target engagement 또는 정량 비임상 데이터는 무엇인가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "Multiple sclerosis fit은 확인되나 molecular MoA/정량 결과가 없어 REJECT다.",
    "missing_evidence_needed_for_full_scout": [
      "molecular target/MoA",
      "interpretable quantitative evidence"
    ]
  }
}
```
