...
record_id: "Lundbeck_Bexicaserin_fast_triage_20260623"
company: "Lundbeck / Longboard Pharmaceuticals"
country: "Europe/UK"
asset: "Bexicaserin / LP352"
...
| Stage | Phase 3 |
| Indication | Developmental and epileptic encephalopathies including Dravet syndrome and Lennox-Gastaut syndrome |
...
High-data DEE seizure asset outside ion-channel core; run Full Scout.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 2 | triage_only | - | 5-HT2C is relevant to seizure network modulation but not a direct SKBP ion-channel target. |  | Bexicaserin PACIFIC trial publication (https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | Clinical seizure reduction data support MoA plausibility in DEE. |  | Lundbeck PACIFIC OLE bexicaserin results (https://www.lundbeck.com/us/newsroom/2025/lundbeck-announces-positive-results-from-12-month-open-label-ext)<br>Bexicaserin PACIFIC trial publication (https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 1b/2a, OLE data, and Phase 3 progression are visible. |  | Lundbeck PACIFIC OLE bexicaserin results (https://www.lundbeck.com/us/newsroom/2025/lundbeck-announces-positive-results-from-12-month-open-label-ext)<br>Bexicaserin PACIFIC trial publication (https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | 5-HT2C is relevant to seizure network modulation but not a direct SKBP ion-channel target. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- SKBP theme fit is less direct than Kv7/SCN1A/KCNT1 assets.
...
|---|---|---|---|---|---|
| Bexicaserin PACIFIC trial publication | publication | high | - | Phase 1b/2a clinical trial of bexicaserin in DEE. | https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Clinical seizure reduction data support MoA plausibility in DEE. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Source | Type | Reliability | Supports Score | Evidence Summary | URL |
|---|---|---|---|---|---|
| Lundbeck PACIFIC OLE bexicaserin results | official_company | high | - | 12-month open-label extension of PACIFIC showed sustained seizure reduction. | https://www.lundbeck.com/us/newsroom/2025/lundbeck-announces-positive-results-from-12-month-open-label-ext |
| Bexicaserin PACIFIC trial publication | publication | high | - | Phase 1b/2a clinical trial of bexicaserin in DEE. | https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Phase 1b/2a, OLE data, and Phase 3 progression are visible. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Phase 3 registrational outcome not yet available.
...
- Bexicaserin/LP352 is a 5-HT2C receptor agonist/superagonist in DEE.
- PACIFIC Phase 1b/2a and OLE data are public.

### Uncertain Points

- Fast triage did not calculate market or compare to fenfluramine.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Network Modulation|Network Modulation]]
- Dashboard record id: `Lundbeck_Bexicaserin_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Lundbeck_Bexicaserin_fast_triage_20260623",
  ...
  "input": {
    "company_input": "Lundbeck / Longboard Pharmaceuticals",
    "asset_input": "Bexicaserin / LP352"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Network Modulation",
    "target_description": "5-HT2C is relevant to seizure network modulation but not a direct SKBP ion-channel target."
  },
  "structured_table": {
    "company": "Lundbeck / Longboard Pharmaceuticals",
    "asset_name": "Bexicaserin / LP352",
    "target": "5-HT2C receptor",
    "moa": "Highly selective 5-HT2C receptor superagonist for seizure reduction in DEE",
    "modality_platform": "Oral small molecule",
    "main_indication": "Epilepsy / seizure disorders",
    "indication": "Developmental and epileptic encephalopathies including Dravet syndrome and Lennox-Gastaut syndrome",
    "development_stage": "Phase 3",
    "company_country": "Europe/UK",
    "sources": [
      {
        "source_title": "Lundbeck PACIFIC OLE bexicaserin results",
        "source_url": "https://www.lundbeck.com/us/newsroom/2025/lundbeck-announces-positive-results-from-12-month-open-label-ext"
      }
    ]
  },
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and MOA/Data are >=2 with TR also plausible; Phase 3 DEE asset.",
    "flags": [
      "fast_triage_only",
      "phase_3",
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "5-HT2C is relevant to seizure network modulation but not a direct SKBP ion-channel target.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "SKBP theme fit is less direct than Kv7/SCN1A/KCNT1 assets."
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Clinical seizure reduction data support MoA plausibility in DEE.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Phase 1b/2a, OLE data, and Phase 3 progression are visible.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Phase 3 registrational outcome not yet available."
  ...
  "validation": {
    ...
    "source_registry": [
      {
        "source_id": "SRC_e7e8c8f1965c",
        "source_title": "Lundbeck PACIFIC OLE bexicaserin results",
        "source_url": "https://www.lundbeck.com/us/newsroom/2025/lundbeck-announces-positive-results-from-12-month-open-label-ext",
        "source_type": "official_company",
        "reliability": "high",
        "evidence_summary": "12-month open-label extension of PACIFIC showed sustained seizure reduction."
      },
      {
        "source_id": "SRC_696db6327b4c",
        "source_title": "Bexicaserin PACIFIC trial publication",
        "source_url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/",
        "source_type": "publication",
        "reliability": "high",
        "evidence_summary": "Phase 1b/2a clinical trial of bexicaserin in DEE."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "High-data DEE seizure asset outside ion-channel core; run Full Scout.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "Does bexicaserin's 5-HT2C selectivity translate into a safer and differentiated profile versus fenfluramine and other DEE therapies?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Clinical data maturity is strong and the seizure network-modulation rationale is plausible despite non-ion-channel target.",
    "missing_evidence_needed_for_full_scout": [
      "Phase 3 DEEp SEA/OCEAN enrollment status",
      "5-HT2C selectivity and off-target safety",
      "Cardiac/valvulopathy risk differentiation versus serotonergic precedents",
      "Subgroup efficacy by Dravet/LGS/DEE other"
    ]
  }
}
```
