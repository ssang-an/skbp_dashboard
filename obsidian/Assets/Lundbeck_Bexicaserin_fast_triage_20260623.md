...
|---|---:|---|---|---|---|---|
| Target Relevance | 2 | triage_only | - | 5-HT2C is relevant to seizure network modulation but not a direct SKBP ion-channel target. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | Clinical seizure reduction data support MoA plausibility in DEE. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 1b/2a, OLE data, and Phase 3 progression are visible. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #9"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "5-HT2C receptor superagonist로 ion-channel 직접 target은 아니지만 DEE seizure Phase 3 및 clinical data가 확인되어 Full Scout 가치가 있다.",
  ...
  "scoring": {
    ...
    "criteria": {
      "target_relevance": {
        ...
        "evidence_sources": [
          "https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/"
        ],
        "uncertain_points": [
          "SKBP theme fit is less direct than Kv7/SCN1A/KCNT1 assets."
        ]
      ...
      "moa_validity": {
        ...
        "evidence_sources": [
          "https://www.lundbeck.com/us/newsroom/2025/lundbeck-announces-positive-results-from-12-month-open-label-ext",
          "https://pmc.ncbi.nlm.nih.gov/articles/PMC12927688/"
        ],
        "uncertain_points": []
      },
