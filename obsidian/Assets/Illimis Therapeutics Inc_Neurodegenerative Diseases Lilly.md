...
record_id: "Illimis Therapeutics Inc_Neurodegenerative Diseases Lilly"
...
# Neurodegenerative Diseases Lilly
...
| Rubric Definition | - |
| Judgment Reason | TR 0점: 협력 분야 설명일 뿐 특정 자산 적응증이 아닙니다. |
| Why Not Higher | 개별 자산 identity가 필요합니다. |
| Investigation Note | 협력과 in-house ILM 프로그램을 혼동하지 않았습니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 0점: 협력 대상 target이 비공개입니다. |
| Why Not Higher | GAIA platform 일반 기전을 특정 협력 자산에 귀속할 수 없습니다. |
| Investigation Note | 개별 construct 공개가 필요합니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 0점: 협력 자산별 결과가 없습니다. |
| Why Not Higher | 연구협력 진행 사실은 자산 데이터가 아닙니다. |
| Investigation Note | 개별 asset result가 필요합니다. |
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Illimis Therapeutics Inc_Neurodegenerative Diseases Lilly`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Illimis Therapeutics Inc_Neurodegenerative Diseases Lilly",
    "report_reupload_history": [
      {
        "id": "f9e44c3b68de4ce1920dc0664e4bb237",
        "replaced_at": "2026-08-06T15:06:12.436720+00:00",
        "actor_ip": "127.0.0.1",
        "previous_record_id": "Illimis Therapeutics Inc_Neurodegenerative Diseases Lilly",
        ...
        "previous_record_snapshot": {
          ...
          "input": {
            "company_input": "Illimis Therapeutics Inc",
            "asset_input": "Neurodegenerative Diseases Lilly"
          },
          "json_summary": {
            "theme": "Unknown",
            "cluster": "Unknown",
            "target_description": "TR 0점: No asset-specific indication."
          },
          "structured_table": {
            "company": "Illimis Therapeutics Inc",
            "asset_name": "Neurodegenerative Diseases Lilly",
            "target": "Unknown",
            "moa": "Unknown",
            ...
            "sources": [
              {
                "source_title": "Illimis at Lilly Gateway Labs",
                "source_url": "https://illimistx.com/en/sub/investor%26media/news.php?bid=16&idx=322&mode=view&page=1"
              }
            ]
          },
          "hard_filter": {
            "status": "UNVERIFIED",
            "reason": "The Illimis-Lilly collaboration is verified, but this is not a discrete asset name.",
            "flags": [
              "identity_not_verified",
              "collaboration_label_not_asset"
            ],
            "hard_blocker": false,
          ...
          "scoring": {
            "criteria": {
              "target_relevance": {
                ...
                "evidence_type_reason": "TR 0점: No asset-specific indication.",
                "evidence_basis": "no_supporting_basis",
                "main_line_summary": "TR 0점: No asset-specific indication.",
                "why_not_higher": "",
                "investigation_note": "",
                "uncertain_points": [],
                "source_ids": []
              ...
              "moa_validity": {
                "score": 0,
                "evidence_type": "triage_only",
                "evidence_type_reason": "MOA 0점: No asset-specific mechanism.",
                "evidence_basis": "no_supporting_basis",
                "main_line_summary": "MOA 0점: No asset-specific mechanism.",
                "why_not_higher": "",
                "investigation_note": "",
                "uncertain_points": [],
                "source_ids": []
              ...
              "data_maturity": {
                "score": 0,
                "evidence_type": "triage_only",
                "evidence_type_reason": "Data 0점: No uniquely named asset result.",
                "evidence_basis": "no_supporting_basis",
                "main_line_summary": "Data 0점: No uniquely named asset result.",
                "why_not_higher": "",
                "investigation_note": "",
                "uncertain_points": [],
                "source_ids": []
          ...
          "validation": {
            ...
            "cross_checked_facts": [
              "Illimis-Lilly platform collaboration began in October 2024.",
              "Illimis joined Lilly Gateway Labs in September 2025."
            ],
            "source_registry": [
              {
                "source_id": "S1",
                ...
                "evidence_summary": "Confirms collaboration, not a discrete asset.",
                "verified": true
              }
            ]
          },
          "final_insight": {
            "one_line_summary": "UNVERIFIED: collaboration label, not a verified candidate.",
            "recommendation": "Verify asset identity",
            "most_important_diligence_question": "What candidate code emerged, and who owns development rights?"
          },
          "triage": {
            "status": "UNVERIFIED",
            ...
            "why": "Partnership descriptor should not be scored as a drug.",
            "missing_evidence_needed_for_full_scout": [
              "Specific construct/code",
              "Ownership, target, indication and stage"
            ]
          }
        }
      }
    ...
    "edit_history": [
      {
        "changed_at": "2026-08-06T15:06:12.436730+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "",
    ...
    "last_edited_at": "2026-08-06T15:06:12.436730+00:00",
  ...
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Illimis-Lilly GAIA 연구협력 설명으로 확인되며 개별 자산명은 아님."
  },
  "structured_table": {
    "company": "Illimis Therapeutics, Inc.",
    "asset_name": "Neurodegenerative Diseases Lilly",
    ...
    "sources": [
      {
        "source_title": "Illimis financing and Lilly research collaboration announcement",
        "source_url": "https://www.illimistx.com/en/sub/investor%26media/news.php?bid=16&idx=282&mode=view&page=1"
      }
    ]
  },
  "hard_filter": {
    "status": "UNVERIFIED",
    "reason": "협력 설명은 확인되지만 특정 biotech/pharma asset identity가 아닙니다.",
    "flags": [
      "collaboration_descriptor_not_asset",
      "undisclosed_collaboration_target"
    ],
    "hard_blocker": false,
    "decision_uncertainty": false
  },
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "TR 0점: 협력 분야 설명일 뿐 특정 자산 적응증이 아닙니다.",
        "why_not_higher": "개별 자산 identity가 필요합니다.",
        "investigation_note": "협력과 in-house ILM 프로그램을 혼동하지 않았습니다.",
        "uncertain_points": [],
        "source_ids": []
      },
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "MOA 0점: 협력 대상 target이 비공개입니다.",
        "why_not_higher": "GAIA platform 일반 기전을 특정 협력 자산에 귀속할 수 없습니다.",
        "investigation_note": "개별 construct 공개가 필요합니다.",
        "uncertain_points": [],
        "source_ids": []
      },
      "data_maturity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "no_supporting_basis",
        "main_line_summary": "Data 0점: 협력 자산별 결과가 없습니다.",
        "why_not_higher": "연구협력 진행 사실은 자산 데이터가 아닙니다.",
        "investigation_note": "개별 asset result가 필요합니다.",
        "uncertain_points": [],
        "source_ids": []
      }
    },
  ...
  "final_insight": {
    "one_line_summary": "협력 descriptor로서 개별 자산 identity가 없어 UNVERIFIED입니다.",
    "recommendation": "Verify asset identity",
    "most_important_diligence_question": "Lilly 협력에서 평가 가능한 개별 자산 코드와 target은 무엇인가?"
  },
  "triage": {
    "status": "UNVERIFIED",
    "identity_verified": false,
    ...
    "why": "공개자료에서 Lilly와의 neurodegenerative-disease 협력은 확인되지만 이 문구는 discrete asset이 아닙니다.",
    "missing_evidence_needed_for_full_scout": [
      "협력 내 개별 자산 코드",
      "target",
      "개발 주체와 권리"
