...
record_id: "Jazz_Saniona_SAN2355_fast_triage_20260623"
company: "Jazz Pharmaceuticals / Saniona"
country: "Europe/UK"
asset: "SAN2355"
target: "Kv7.2/Kv7.3"
theme: "E/I Balance"
...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | Kv7.2/Kv7.3 is directly relevant to E/I Balance and seizure suppression. |  | Jazz Pharmaceuticals enters exclusive licensing agreement for SAN2355 (https://investor.jazzpharma.com/news-releases/news-release-details/jazz-pharmaceuticals-enters-exclusive-licensing-agreement) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 2 | triage_only | - | MoA is class-validated, but SAN2355-specific public data are still preclinical and limited. |  | Jazz Pharmaceuticals enters exclusive licensing agreement for SAN2355 (https://investor.jazzpharma.com/news-releases/news-release-details/jazz-pharmaceuticals-enters-exclusive-licensing-agreement) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 1 | triage_only | - | Preclinical/IND-enabling only; maturity is low. |  | Jazz Pharmaceuticals enters exclusive licensing agreement for SAN2355 (https://investor.jazzpharma.com/news-releases/news-release-details/jazz-pharmaceuticals-enters-exclusive-licensing-agreement) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | Kv7.2/Kv7.3 is directly relevant to E/I Balance and seizure suppression. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| Jazz Pharmaceuticals enters exclusive licensing agreement for SAN2355 | official_company | high | - | SAN2355 is a preclinical selective small molecule activator of Kv7.2/Kv7.3 potassium channels for epilepsy. | https://investor.jazzpharma.com/news-releases/news-release-details/jazz-pharmaceuticals-enters-exclusive-licensing-agreement |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | MoA is class-validated, but SAN2355-specific public data are still preclinical and limited. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Preclinical/IND-enabling only; maturity is low. |
| Why Not Higher |  |
| Investigation Note |  |
...
- SAN2355 is publicly identified as a preclinical selective Kv7.2/Kv7.3 activator.
- Jazz licensing signal confirms pharma interest.

### Uncertain Points

- Preclinical data details are sparse in public sources.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Ion Channel|Ion Channel]]
- Dashboard record id: `Jazz_Saniona_SAN2355_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Jazz_Saniona_SAN2355_fast_triage_20260623",
  ...
  "input": {
    "company_input": "Jazz Pharmaceuticals / Saniona",
    "asset_input": "SAN2355"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Ion Channel",
    "target_description": "Kv7.2/Kv7.3 is directly relevant to E/I Balance and seizure suppression."
  },
  "structured_table": {
    "company": "Jazz Pharmaceuticals / Saniona",
    "asset_name": "SAN2355",
    "target": "Kv7.2/Kv7.3",
    "moa": "Selective small-molecule activator of Kv7.2/Kv7.3 potassium channels",
    ...
    "sources": [
      {
        "source_title": "Jazz Pharmaceuticals enters exclusive licensing agreement for SAN2355",
        "source_url": "https://investor.jazzpharma.com/news-releases/news-release-details/jazz-pharmaceuticals-enters-exclusive-licensing-agreement"
      }
    ]
  },
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and TR/MOA are >=2; selected despite low data maturity because it is a pharma-licensed Kv7.2/7.3 preclinical epilepsy benchmark.",
    "flags": [
      "fast_triage_only",
      "preclinical_asset",
      "bd_benchmark"
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "Kv7.2/Kv7.3 is directly relevant to E/I Balance and seizure suppression.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "MoA is class-validated, but SAN2355-specific public data are still preclinical and limited.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Asset-specific efficacy package not assessed."
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Preclinical/IND-enabling only; maturity is low.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "No visible human data."
  ...
  "validation": {
    ...
    "source_registry": [
      {
        "source_id": "SRC_0cd6c320c619",
        "source_title": "Jazz Pharmaceuticals enters exclusive licensing agreement for SAN2355",
        "source_url": "https://investor.jazzpharma.com/news-releases/news-release-details/jazz-pharmaceuticals-enters-exclusive-licensing-agreement",
        "source_type": "official_company",
        "reliability": "high",
        "evidence_summary": "SAN2355 is a preclinical selective small molecule activator of Kv7.2/Kv7.3 potassium channels for epilepsy."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "Early Kv7.2/7.3 asset with BD benchmark value; run Full Scout if mapping Kv7 deal space.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "What did Jazz see in SAN2355 that differentiates it from other Kv7.2/7.3 activators?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Same target/MoA as NS-041 class and externally validated by Jazz licensing signal; data remains early.",
    "missing_evidence_needed_for_full_scout": [
      "IND-enabling package",
      "Preclinical efficacy data",
      "Selectivity and off-target panel",
      "Deal economics and rights scope"
    ]
  }
}
```
