...
record_id: "Kine Sciences_KINE-501B"
...
| Stage | Hit Discovery |
| Indication | Frontotemporal Dementia (FTD) |
| Modality | Peptide |
| Hard Filter | REJECT |
| Total Score | 1 / 9 |
...
FTD fit과 공개 MoA/Data가 부족하다.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 1 | triage_only | - | TR 1 points: FTD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다. | 관심 적응증이 확인되지 않았다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501B (https://synapse.patsnap.com/drug/fa379a83484c4982992f41e41835858a) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다. | 확인된 기전이 없다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501B (https://synapse.patsnap.com/drug/fa379a83484c4982992f41e41835858a) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다. | Discovery 표기만으로는 결과가 아니다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501B (https://synapse.patsnap.com/drug/fa379a83484c4982992f41e41835858a) |
| Marketability | - | - | - | - | - | - |
...
| Evidence Type Reason | TR 1 points: FTD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다. |
| Rubric Definition | - |
| Judgment Reason | TR 1 points: FTD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다. |
| Why Not Higher | 관심 적응증이 확인되지 않았다. |
| Investigation Note | 공식 pipeline/Synapse 확인. |
...
| Synapse: KINE-501B | biopharma_database | - | - | - | https://synapse.patsnap.com/drug/fa379a83484c4982992f41e41835858a |
...
| Why Not Higher | Discovery 표기만으로는 결과가 아니다. |
| Investigation Note |  |
...
- 공식 pipeline: KINE-501B/FTD/Microglial.
- Synapse: synthetic peptide, Discovery.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Kine Sciences_KINE-501B`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Kine Sciences_KINE-501B",
  ...
  "input": {
    ...
    "asset_input": "KINE-501B"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "FTD CNS program; Target Cell=Microglial, molecular target undisclosed."
  },
  "structured_table": {
    "company": "Kine Sciences",
    "asset_name": "KINE-501B",
    "target": "Microglia (target cell); molecular target Unknown",
    "moa": "Unknown",
    "modality_platform": "Peptide",
    "main_indication": "Frontotemporal dementia",
    "indication": "Frontotemporal Dementia (FTD)",
  ...
  "hard_filter": {
    "status": "REJECT",
    "reason": "FTD는 관심 적응증 밖이고 공개 MoA/Data가 부족하다.",
    "flags": [
      "outside_interest_indication",
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "TR 1 points: FTD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 1 points: FTD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다.",
        "why_not_higher": "관심 적응증이 확인되지 않았다.",
        "investigation_note": "공식 pipeline/Synapse 확인.",
        "uncertain_points": [],
        "source_ids": [
          "S1",
          "S2"
      ...
      "data_maturity": {
        ...
        "why_not_higher": "Discovery 표기만으로는 결과가 아니다.",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
          "S1",
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "S2",
        "source_title": "Synapse: KINE-501B",
        "source_url": "https://synapse.patsnap.com/drug/fa379a83484c4982992f41e41835858a",
  ...
  "final_insight": {
    "one_line_summary": "FTD fit과 공개 MoA/Data가 부족하다.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "관심 적응증 또는 비공개 functional package가 있는가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "현재 등재된 FTD 자산이나 SKBP fit과 공개 MoA/Data가 부족해 REJECT다.",
