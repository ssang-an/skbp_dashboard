...
record_id: "Korea Pharma Co Ltd_KP-101"
...
|---|---:|---|---|---|---|---|
| Target Relevance | 0 | triage_only | - | TR 0 points: Major depressive disorder는 본 triage의 SKBP 관련 질환 범위 밖이다. | 관심/qualifying neurologic indication이 없다. | Korea Pharma Research Results (https://koreapharma.co.kr/eng/sub_research/result.php) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0 points: target 또는 asset-specific MoA가 확인되지 않았다. | 기전 근거가 없다. | Korea Pharma Research Results (https://koreapharma.co.kr/eng/sub_research/result.php) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다. | Pipeline listing은 결과가 아니다. | Korea Pharma Research Results (https://koreapharma.co.kr/eng/sub_research/result.php) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 0 points: Major depressive disorder는 본 triage의 SKBP 관련 질환 범위 밖이다. |
...
|---|---|---|---|---|---|
| Korea Pharma Research Results | official_company_rnd | - | - | - | https://koreapharma.co.kr/eng/sub_research/result.php |
...
| Rubric Definition | - |
| Judgment Reason | MOA 0 points: target 또는 asset-specific MoA가 확인되지 않았다. |
...
| Investigation Note | 공식 페이지 텍스트에서 current stage marker도 확정 불가. |
...
- 공식 R&D: KP 101/major depressive disorder.
- 회사 주소: Seoul, Republic of Korea.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Korea Pharma Co Ltd_KP-101`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Korea Pharma Co Ltd_KP-101",
  ...
  "input": {
    "company_input": "Korea Pharma Co Ltd",
    "asset_input": "KP-101"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "Major depressive disorder project; target/MoA undisclosed."
  },
  "structured_table": {
    "company": "Korea Pharma Co Ltd",
    "asset_name": "KP-101",
    ...
    "sources": [
      {
        "source_title": "Korea Pharma Research Results",
        "source_url": "https://koreapharma.co.kr/eng/sub_research/result.php"
      }
    ]
  },
  "hard_filter": {
    "status": "REJECT",
    "reason": "MDD는 본 triage의 SKBP 관련 범위 밖이고 공개 MoA/Data가 없다.",
    "flags": [
      "outside_skbp_scope",
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "TR 0 points: Major depressive disorder는 본 triage의 SKBP 관련 질환 범위 밖이다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 0 points: Major depressive disorder는 본 triage의 SKBP 관련 질환 범위 밖이다.",
        "why_not_higher": "관심/qualifying neurologic indication이 없다.",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
          "S1"
      ...
      "moa_validity": {
        "score": 0,
        "evidence_type": "triage_only",
        "evidence_type_reason": "MOA 0 points: target 또는 asset-specific MoA가 확인되지 않았다.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 0 points: target 또는 asset-specific MoA가 확인되지 않았다.",
        "why_not_higher": "기전 근거가 없다.",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
          "S1"
      ...
      "data_maturity": {
        ...
        "why_not_higher": "Pipeline listing은 결과가 아니다.",
        "investigation_note": "공식 페이지 텍스트에서 current stage marker도 확정 불가.",
        "uncertain_points": [],
        "source_ids": [
          "S1"
        ]
  ...
  "final_insight": {
    "one_line_summary": "MDD는 triage 범위 밖이며 공개 MoA/Data도 없다.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "관심 적응증 또는 target/MoA package가 있는가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "현재 R&D 등재는 확인되나 적응증 fit과 공개 MoA/Data가 부족해 REJECT다.",
