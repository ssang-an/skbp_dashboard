...
record_id: "Kine Sciences_KINE-501C"
...
LBD fit과 공개 MoA/Data가 부족하다.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 1 | triage_only | - | TR 1 points: LBD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다. | 관심 적응증이 확인되지 않았다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501C (https://synapse.patsnap.com/drug/bcc0e499d38b45db9154b737b344da60) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 0 | triage_only | - | MOA 0 points: Microglial target cell만 확인되고 molecular target/MoA는 미확인이다. | 확인된 기전이 없다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501C (https://synapse.patsnap.com/drug/bcc0e499d38b45db9154b737b344da60) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0 points: 공개 asset-specific 정량 결과가 확인되지 않았다. | Discovery 표기만으로는 결과가 아니다. | Kine Sciences Pipeline (https://www.kinesciences.com/m31.php)<br>Synapse: KINE-501C (https://synapse.patsnap.com/drug/bcc0e499d38b45db9154b737b344da60) |
| Marketability | - | - | - | - | - | - |
...
| Evidence Type Reason | TR 1 points: LBD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다. |
| Rubric Definition | - |
| Judgment Reason | TR 1 points: LBD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다. |
| Why Not Higher | 관심 적응증이 확인되지 않았다. |
| Investigation Note | LBD는 canonical main_indication bucket 부재로 Unknown. |
...
| Synapse: KINE-501C | biopharma_database | - | - | - | https://synapse.patsnap.com/drug/bcc0e499d38b45db9154b737b344da60 |
...
- 공식 pipeline: KINE-501C/LBD/Microglial.
...
- Theme: [[Theme - Unknown|Unknown]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Kine Sciences_KINE-501C`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Kine Sciences_KINE-501C",
  ...
  "input": {
    ...
    "asset_input": "KINE-501C"
  },
  "json_summary": {
    "theme": "Unknown",
    "cluster": "Unknown",
    "target_description": "LBD CNS program; Target Cell=Microglial, molecular target undisclosed."
  },
  "structured_table": {
    "company": "Kine Sciences",
    "asset_name": "KINE-501C",
    "target": "Microglia (target cell); molecular target Unknown",
    "moa": "Unknown",
  ...
  "hard_filter": {
    "status": "REJECT",
    "reason": "LBD는 관심 적응증 밖이고 공개 MoA/Data가 부족하다.",
    "flags": [
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_type_reason": "TR 1 points: LBD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다.",
        "evidence_basis": "public_source",
        "main_line_summary": "TR 1 points: LBD는 신경퇴행성 질환이나 6개 관심 적응증 밖이다.",
        "why_not_higher": "관심 적응증이 확인되지 않았다.",
        "investigation_note": "LBD는 canonical main_indication bucket 부재로 Unknown.",
        "uncertain_points": [],
        "source_ids": [
          "S1",
          "S2"
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "S2",
        "source_title": "Synapse: KINE-501C",
        "source_url": "https://synapse.patsnap.com/drug/bcc0e499d38b45db9154b737b344da60",
  ...
  "final_insight": {
    "one_line_summary": "LBD fit과 공개 MoA/Data가 부족하다.",
  ...
  "triage": {
    ...
    "why": "현재 등재된 LBD 자산이나 SKBP fit과 공개 MoA/Data가 부족해 REJECT다.",
