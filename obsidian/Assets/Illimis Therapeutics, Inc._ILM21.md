...
record_id: "Illimis Therapeutics, Inc._ILM21"
company: "Illimis Therapeutics, Inc."
country: "Republic of Korea"
asset: "ILM21"
target: "Myelin debris"
theme: "Neuroimmune"
cluster: "Unknown"
stage: "Unknown"
total_score: 4
...
MS와 myelin-debris fit은 높지만 자산별 기능성·데이터 부재로 REJECT.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | TR 3점: Multiple sclerosis와 myelin debris 직접 표적이 공식 파이프라인에서 확인됩니다. | 최고점입니다. | Illimis official pipeline (https://illimistx.com/en/sub/platform%26pipeline/pipeline.php) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 1 | triage_only | - | MOA 1점: GAIA/TAM 기반 myelin-debris clearance 설계는 확인되지만 회사 rationale 수준입니다. | ILM21 자체 functional assay가 공개되지 않았습니다. | Illimis official pipeline (https://illimistx.com/en/sub/platform%26pipeline/pipeline.php)<br>Illimis GAIA platform description (https://illimistx.com/en/sub/platform%26pipeline/platform.php) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 0 | triage_only | - | Data 0점: ILM21 자산별 결과가 공개 확인되지 않았습니다. | 정량 결과가 없습니다. | - |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 3점: Multiple sclerosis와 myelin debris 직접 표적이 공식 파이프라인에서 확인됩니다. |
| Why Not Higher | 최고점입니다. |
| Investigation Note | 제공된 UNVERIFIED 임시 판정을 공식 자료로 교정했습니다. |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 1점: GAIA/TAM 기반 myelin-debris clearance 설계는 확인되지만 회사 rationale 수준입니다. |
| Why Not Higher | ILM21 자체 functional assay가 공개되지 않았습니다. |
| Investigation Note | 플랫폼과 자산별 근거를 분리했습니다. |

#### Conflicting Or Missing Evidence

- ILM21-specific validation
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 0점: ILM21 자산별 결과가 공개 확인되지 않았습니다. |
| Why Not Higher | 정량 결과가 없습니다. |
| Investigation Note | myelin phagocytosis, neuroinflammation 및 EAE 효능 자료가 필요합니다. |
...
- Theme: [[Theme - Neuroimmune|Neuroimmune]]
- Cluster: [[Cluster - Unknown|Unknown]]
- Dashboard record id: `Illimis Therapeutics, Inc._ILM21`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Illimis Therapeutics, Inc._ILM21",
  ...
  "json_summary": {
    "theme": "Neuroimmune",
    "cluster": "Unknown",
    "target_description": "Multiple sclerosis에서 myelin debris를 표적하는 GAIA/TAM fusion-protein 프로그램."
  },
  "structured_table": {
    "company": "Illimis Therapeutics, Inc.",
    "asset_name": "ILM21",
    "target": "Myelin debris",
    "moa": "GAIA/TAM-receptor-mediated anti-inflammatory phagocytic clearance of myelin debris",
  ...
  "hard_filter": {
    "status": "REJECT",
    "reason": "TR 3점이나 MOA 1점·Data 0점으로 SELECT 조건을 충족하지 못합니다.",
    "flags": [
      "corrected_from_unverified",
      "interest_indication",
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "main_line_summary": "TR 3점: Multiple sclerosis와 myelin debris 직접 표적이 공식 파이프라인에서 확인됩니다.",
        "why_not_higher": "최고점입니다.",
        "investigation_note": "제공된 UNVERIFIED 임시 판정을 공식 자료로 교정했습니다.",
        "uncertain_points": [],
        "source_ids": [
          "ILM21_1"
        ]
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 1점: GAIA/TAM 기반 myelin-debris clearance 설계는 확인되지만 회사 rationale 수준입니다.",
        "why_not_higher": "ILM21 자체 functional assay가 공개되지 않았습니다.",
        "investigation_note": "플랫폼과 자산별 근거를 분리했습니다.",
        "uncertain_points": [
          "ILM21-specific validation"
        ],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "main_line_summary": "Data 0점: ILM21 자산별 결과가 공개 확인되지 않았습니다.",
        "why_not_higher": "정량 결과가 없습니다.",
        "investigation_note": "myelin phagocytosis, neuroinflammation 및 EAE 효능 자료가 필요합니다.",
        "uncertain_points": [],
        "source_ids": []
      }
    },
  ...
  "final_insight": {
    "one_line_summary": "MS와 myelin-debris fit은 높지만 자산별 기능성·데이터 부재로 REJECT.",
    "recommendation": "Do not run Full Scout",
    "most_important_diligence_question": "ILM21이 myelin debris clearance와 MS 모델 효능을 직접 입증했는가?"
  },
  "triage": {
    "status": "REJECT",
    ...
    "why": "공식 파이프라인에서 자산 identity와 MS 적응증이 확인되지만 기능성 MoA·데이터가 부족해 REJECT입니다.",
    "missing_evidence_needed_for_full_scout": [
      "ILM21-specific functional evidence",
      "정량 myelin-clearance data",
      "현재 개발 단계"
    ]
  }
}
