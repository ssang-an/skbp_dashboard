...
직접 ApoE4 기능성 근거가 있는 활성 AD 후보로 Full Scout 권고.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | TR 3점: AD 적응증과 ApoE4 직접 표적이 확인됩니다. | 최고점입니다. | ADEL official pipeline status (https://adelpharm.com/en/pipeline/)<br>ApoE4 antibody ameliorates cognitive impairments and synapse loss in ApoE4/Tau-P301S mice (https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.088537) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | MOA 3점: ADEL-Y04가 ApoE4 모델에서 기억, 시냅스 및 tau 병리에 직접 기능 효과를 보였습니다. | 자산별 target-engagement 수치는 공개되지 않았습니다. | ApoE4 antibody ameliorates cognitive impairments and synapse loss in ApoE4/Tau-P301S mice (https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.088537) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 1 | triage_only | - | Data 1점: 동물모델의 기억 개선과 synapse/tau 억제가 정성적으로 공개됐습니다. | 용량, 효과크기, 통계 및 PK가 공개되지 않았습니다. | ApoE4 antibody ameliorates cognitive impairments and synapse loss in ApoE4/Tau-P301S mice (https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.088537) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | TR 3점: AD 적응증과 ApoE4 직접 표적이 확인됩니다. |
| Why Not Higher | 최고점입니다. |
| Investigation Note | 공식 파이프라인과 자산 페이지를 확인했습니다. |
...
|---|---|---|---|---|---|
| ADEL official pipeline status | official_company_pipeline | - | - | - | https://adelpharm.com/en/pipeline/ |
| ApoE4 antibody ameliorates cognitive impairments and synapse loss in ApoE4/Tau-P301S mice | peer_reviewed_conference_abstract | - | - | - | https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.088537 |
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | MOA 3점: ADEL-Y04가 ApoE4 모델에서 기억, 시냅스 및 tau 병리에 직접 기능 효과를 보였습니다. |
| Why Not Higher | 자산별 target-engagement 수치는 공개되지 않았습니다. |
| Investigation Note | 학회 초록 수준의 자산별 기능성 검증입니다. |

#### Conflicting Or Missing Evidence

- target engagement 미공개
...
| Evidence Type Reason | Fast Triage v3.3 예비 평가. |
| Rubric Definition | - |
| Judgment Reason | Data 1점: 동물모델의 기억 개선과 synapse/tau 억제가 정성적으로 공개됐습니다. |
| Why Not Higher | 용량, 효과크기, 통계 및 PK가 공개되지 않았습니다. |
| Investigation Note | 정량 원자료가 필요합니다. |
...
- Theme: [[Theme - Others|Others]]
- Cluster: [[Cluster - Others|Others]]
- Dashboard record id: `ADEL, Inc._ADEL-Y04`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "ADEL, Inc._ADEL-Y04",
  ...
  "json_summary": {
    "theme": "Others",
    "cluster": "Others",
    "target_description": "ApoE4를 선택적으로 표적하는 알츠하이머병 전임상 단클론항체."
  },
  "structured_table": {
    "company": "ADEL, Inc.",
    "asset_name": "ADEL-Y04",
    "target": "Apolipoprotein E4 (ApoE4)",
    "moa": "ApoE4-selective antibody intended to reduce ApoE4-linked tau pathology, synapse loss and cognitive impairment",
    ...
    "sources": [
      {
        "source_title": "ADEL official pipeline status",
        "source_url": "https://adelpharm.com/en/pipeline/"
      }
    ]
  },
  "hard_filter": {
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "main_line_summary": "TR 3점: AD 적응증과 ApoE4 직접 표적이 확인됩니다.",
        "why_not_higher": "최고점입니다.",
        "investigation_note": "공식 파이프라인과 자산 페이지를 확인했습니다.",
        "uncertain_points": [],
        "source_ids": [
          "ADEL1",
          "ADEL2"
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "MOA 3점: ADEL-Y04가 ApoE4 모델에서 기억, 시냅스 및 tau 병리에 직접 기능 효과를 보였습니다.",
        "why_not_higher": "자산별 target-engagement 수치는 공개되지 않았습니다.",
        "investigation_note": "학회 초록 수준의 자산별 기능성 검증입니다.",
        "uncertain_points": [
          "target engagement 미공개"
        ],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "Fast Triage v3.3 예비 평가.",
        "evidence_basis": "public_source",
        "main_line_summary": "Data 1점: 동물모델의 기억 개선과 synapse/tau 억제가 정성적으로 공개됐습니다.",
        "why_not_higher": "용량, 효과크기, 통계 및 PK가 공개되지 않았습니다.",
        "investigation_note": "정량 원자료가 필요합니다.",
        "uncertain_points": [
          "정량 결과 제한"
        ],
        "source_ids": [
  ...
  "validation": {
    ...
    "source_registry": [
      ...
      {
        "source_id": "ADEL2",
        "source_title": "ApoE4 antibody ameliorates cognitive impairments and synapse loss in ApoE4/Tau-P301S mice",
        "source_url": "https://alz-journals.onlinelibrary.wiley.com/doi/10.1002/alz.088537",
  ...
  "final_insight": {
    "one_line_summary": "직접 ApoE4 기능성 근거가 있는 활성 AD 후보로 Full Scout 권고.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "ADEL-Y04의 정량 효능, 뇌 노출 및 target-engagement 자료는 무엇인가?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "활성 AD 전임상 프로그램이며 자산별 동물 기능성 근거로 TR 3점·MOA 3점을 충족합니다.",
