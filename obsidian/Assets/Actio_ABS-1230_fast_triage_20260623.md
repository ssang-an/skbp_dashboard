...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | KCNT1 is directly linked to genetic epilepsy and ion-channel dysregulation. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 2 | triage_only | - | Selective KCNT1 inhibition is plausible for gain-of-function KCNT1-related epilepsy, but patient efficacy is not yet visible. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 2 | triage_only | - | Early clinical Phase 1/2 development is visible. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #6"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "KCNT1-related epilepsy를 겨냥한 oral selective KCNT1 inhibitor로 genetically defined epilepsy scout 후보로 적합하다.",
  ...
  "scoring": {
    ...
    "criteria": {
      ...
      "data_maturity": {
        ...
        "evidence_sources": [
          "https://www.clinicaltrialsarena.com/news/actio-biosciences-begins-abs-1230-trial/"
        ],
        "uncertain_points": [
          "No clinical efficacy readout found in fast triage."
        ]
