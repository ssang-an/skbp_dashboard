...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | KCNT1 is directly linked to genetic epilepsy and ion-channel dysregulation. |  | Actio first participant dosed in Phase 1 ABS-1230 (https://actiobiosciences.com/actio-biosciences-announces-first-participant-dosed-in-phase-1-clinical-trial-of-abs-1230-a-kcnt1-inhibitor-for-the-treatment-of-kcnt1-related-epilepsy/) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 2 | triage_only | - | Selective KCNT1 inhibition is plausible for gain-of-function KCNT1-related epilepsy, but patient efficacy is not yet visible. |  | Actio first participant dosed in Phase 1 ABS-1230 (https://actiobiosciences.com/actio-biosciences-announces-first-participant-dosed-in-phase-1-clinical-trial-of-abs-1230-a-kcnt1-inhibitor-for-the-treatment-of-kcnt1-related-epilepsy/) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 2 | triage_only | - | Early clinical Phase 1/2 development is visible. |  | Clinical Trials Arena ABS-1230 Phase Ib/II trial (https://www.clinicaltrialsarena.com/news/actio-biosciences-begins-abs-1230-trial/) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | KCNT1 is directly linked to genetic epilepsy and ion-channel dysregulation. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| Actio first participant dosed in Phase 1 ABS-1230 | official_company | high | - | ABS-1230 is described as an oral selective KCNT1 inhibitor for KCNT1-related epilepsy. | https://actiobiosciences.com/actio-biosciences-announces-first-participant-dosed-in-phase-1-clinical-trial-of-abs-1230-a-kcnt1-inhibitor-for-the-treatment-of-kcnt1-related-epilepsy/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Selective KCNT1 inhibition is plausible for gain-of-function KCNT1-related epilepsy, but patient efficacy is not yet visible. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Human efficacy not yet visible.
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Early clinical Phase 1/2 development is visible. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- No clinical efficacy readout found in fast triage.
...
| Source | Type | Reliability | Supports Score | Evidence Summary | URL |
|---|---|---|---|---|---|
| Clinical Trials Arena ABS-1230 Phase Ib/II trial | news | medium | - | KYRON Phase Ib/II trial of ABS-1230 in KCNT1-related epilepsy reported. | https://www.clinicaltrialsarena.com/news/actio-biosciences-begins-abs-1230-trial/ |
...
- ABS-1230 is an oral selective KCNT1 inhibitor.
- KCNT1-related epilepsy clinical development is publicly described.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Ion Channel|Ion Channel]]
- Dashboard record id: `Actio_ABS-1230_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Actio_ABS-1230_fast_triage_20260623",
  ...
  "input": {
    "company_input": "Actio Biosciences",
    "asset_input": "ABS-1230"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Ion Channel",
    "target_description": "KCNT1 is directly linked to genetic epilepsy and ion-channel dysregulation."
  },
  "structured_table": {
    "company": "Actio Biosciences",
    "asset_name": "ABS-1230",
    "target": "KCNT1",
    "moa": "Selective KCNT1 ion-channel inhibitor",
    ...
    "sources": [
      {
        "source_title": "Actio first participant dosed in Phase 1 ABS-1230",
  ...
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and at least two of TR/MOA/Data are >=2; genetically defined ion-channel epilepsy asset.",
    "flags": [
      "fast_triage_only",
      "rare_epilepsy",
      "early_clinical"
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "KCNT1 is directly linked to genetic epilepsy and ion-channel dysregulation.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Selective KCNT1 inhibition is plausible for gain-of-function KCNT1-related epilepsy, but patient efficacy is not yet visible.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Human efficacy not yet visible."
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Early clinical Phase 1/2 development is visible.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "No clinical efficacy readout found in fast triage."
    ...
    "source_registry": [
      {
        ...
        "reliability": "high",
        "evidence_summary": "ABS-1230 is described as an oral selective KCNT1 inhibitor for KCNT1-related epilepsy."
      },
      {
        "source_id": "SRC_6e887af82e17",
        "source_title": "Clinical Trials Arena ABS-1230 Phase Ib/II trial",
        "source_url": "https://www.clinicaltrialsarena.com/news/actio-biosciences-begins-abs-1230-trial/",
        "source_type": "news",
        "reliability": "medium",
        "evidence_summary": "KYRON Phase Ib/II trial of ABS-1230 in KCNT1-related epilepsy reported."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "Genetically defined rare epilepsy ion-channel asset; run Full Scout.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "Does ABS-1230 inhibit the clinically relevant KCNT1 variants with a sufficient CNS safety window?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "KCNT1 is an ion-channel epilepsy target and ABS-1230 has entered early clinical development.",
    "missing_evidence_needed_for_full_scout": [
      "Phase Ib/II patient data",
      "KCNT1 mutation coverage",
      "Preclinical efficacy across variants",
      "Safety window for KCNT1 inhibition"
    ]
  }
}
```
