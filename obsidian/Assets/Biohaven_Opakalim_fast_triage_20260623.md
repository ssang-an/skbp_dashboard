...
record_id: "Biohaven_Opakalim_fast_triage_20260623"
company: "Biohaven"
...
| Stage | Phase 2/3 |
| Indication | Focal epilepsy and broader epilepsy populations |
...
Strong same-class Kv7.2/7.3 comparator; run Full Scout.

## Scoring

| Criterion | Score | Evidence Type | Rubric Definition | Judgment Reason | Why Not Higher | Evidence Sources |
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | Kv7.2/Kv7.3 directly fits E/I Balance ion-channel biology. |  | Biohaven Kv7 Ion Channel Modulation Platform (https://www.biohaven.com/pipeline/innovation-engine/kv7/) |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | Selective Kv7.2/7.3 activation is clinically plausible and directly relevant to seizure hyperexcitability. |  | Biohaven Kv7 Ion Channel Modulation Platform (https://www.biohaven.com/pipeline/innovation-engine/kv7/) |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Pivotal epilepsy development and clinical data signals are visible. |  | Biohaven Reports New Clinical Data in Epilepsy with Opakalim (https://www.prnewswire.com/news-releases/biohaven-reports-new-clinical-data-in-epilepsy-with-opakalim-a-selective-kv7-27-3-activator-highlighting-seizure-control-and-markedly-differentiated-tolerability-profile-302781743.html) |
| Marketability | - | - | - | - | - | - |
...
| Rubric Definition | - |
| Judgment Reason | Kv7.2/Kv7.3 directly fits E/I Balance ion-channel biology. |
| Why Not Higher |  |
| Investigation Note |  |
...
|---|---|---|---|---|---|
| Biohaven Kv7 Ion Channel Modulation Platform | official_company | high | - | Opakalim is described as a potent selective Kv7.2/7.3 activator. | https://www.biohaven.com/pipeline/innovation-engine/kv7/ |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Selective Kv7.2/7.3 activation is clinically plausible and directly relevant to seizure hyperexcitability. |
| Why Not Higher |  |
| Investigation Note |  |
...
| Evidence Type Reason |  |
| Rubric Definition | - |
| Judgment Reason | Pivotal epilepsy development and clinical data signals are visible. |
| Why Not Higher |  |
| Investigation Note |  |

#### Conflicting Or Missing Evidence

- Full pivotal readout not assessed in fast triage.
...
| Source | Type | Reliability | Supports Score | Evidence Summary | URL |
|---|---|---|---|---|---|
| Biohaven Reports New Clinical Data in Epilepsy with Opakalim | news | medium | - | New clinical data in epilepsy with selective Kv7.2/7.3 activator opakalim. | https://www.prnewswire.com/news-releases/biohaven-reports-new-clinical-data-in-epilepsy-with-opakalim-a-selective-kv7-27-3-activator-highlighting-seizure-control-and-markedly-differentiated-tolerability-profile-302781743.html |
...
- Opakalim/BHV-7000 is Biohaven's Kv7.2/7.3 activator.
- Epilepsy clinical development is publicly visible.

### Uncertain Points

- Fast triage did not verify full trial registry set or controlled pivotal outcomes.
...
- Theme: [[Theme - E-I Balance|E/I Balance]]
- Cluster: [[Cluster - Ion Channel|Ion Channel]]
- Dashboard record id: `Biohaven_Opakalim_fast_triage_20260623`
...
```json
{
  "meta": {
    ...
    "output_filename_base": "Biohaven_Opakalim_fast_triage_20260623",
    ...
    "human_review": {
      ...
      "history": [
        {
          "changed_at": "2026-08-20T01:35:44.016326+00:00",
          "actor_ip": "127.0.0.1",
          "actor_name": "정주원",
        ...
        {
          "changed_at": "2026-08-20T03:48:15.152682+00:00",
          "actor_ip": "127.0.0.1",
          "actor_name": "",
          "source": "dashboard_rubric_refresh",
          "change_method": "rubric_refresh_latest_v3.3",
          "field": "scores.target_relevance",
          "previous_value": 2,
          "new_value": 3
        },
        {
          "changed_at": "2026-08-20T03:49:29.919594+00:00",
          "actor_ip": "127.0.0.1",
          "actor_name": "정주원",
          "source": "dashboard_table",
          "field": "final_comment",
        ...
        {
          "changed_at": "2026-08-20T03:49:41.582725+00:00",
          "actor_ip": "127.0.0.1",
          "actor_name": "정주원",
      ...
      "last_updated_at": "2026-08-20T03:49:41.582725+00:00",
      "last_updated_source": "dashboard_table",
      "last_updated_by": "정주원",
      "has_manual_override": true,
      "last_scoring_override_reset_at": "2026-08-20T03:48:15.152682+00:00",
      "last_scoring_override_reset_source": "dashboard_tab2_rubric_refresh"
    },
    "edit_history": [
      {
        "id": "0e5546e66ee84b5eb3b7e8c381727ba5",
        "changed_at": "2026-08-20T01:35:44.016385+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "정주원",
      ...
      {
        "id": "99c1a07e76274bee954bcb4e93f56b67",
        "changed_at": "2026-08-20T03:48:15.152737+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "",
        "source": "dashboard_rubric_refresh",
        "field": "scores.target_relevance",
      ...
      {
        "id": "5d6d71ebf23e4ffe8336493ae774e5e6",
        "changed_at": "2026-08-20T03:49:29.919616+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "정주원",
        "source": "dashboard_table_manual_review",
        "field": "final_comment",
      ...
      {
        "id": "7719ece9a05e4a03881d9eb2e2d919b8",
        "changed_at": "2026-08-20T03:49:41.582753+00:00",
        "actor_ip": "127.0.0.1",
        "actor_name": "정주원",
        "source": "detail_final_comment_delete",
        "field": "final_comment",
    ...
    "rubric_reviewed_at": "2026-08-20T03:48:15.152682+00:00",
    "rubric_reviewed_by": "127.0.0.1",
    "rubric_review_result": "manual_override_reset",
    "rubric_refresh_history": [
      {
        "version": "3.3",
        "reviewed_at": "2026-08-20T03:48:15.152682+00:00",
        "result": "manual_override_reset",
        "actor_ip": "127.0.0.1",
        "reason": "기존 점수(TR 3, MoA 3, Data 3)는 최신 루브릭 v3.3 기준과 일치하며, 변경을 정당화할 구체적이고 명확한 증거가 없습니다.",
        "changes": []
      }
    ]
  },
  ...
  "input": {
    "company_input": "Biohaven",
    "asset_input": "Opakalim / BHV-7000"
  },
  "json_summary": {
    "theme": "E/I Balance",
    "cluster": "Ion Channel",
    "target_description": "Kv7.2/Kv7.3 directly fits E/I Balance ion-channel biology."
  },
  "structured_table": {
    "company": "Biohaven",
    "asset_name": "Opakalim / BHV-7000",
    "target": "Kv7.2/Kv7.3",
    "moa": "Selective Kv7.2/Kv7.3 potassium channel activator",
    "modality_platform": "Small molecule",
    "main_indication": "Epilepsy / seizure disorders",
    "indication": "Focal epilepsy and broader epilepsy populations",
    "development_stage": "Phase 2/3",
    "company_country": "United States",
    "sources": [
      {
        "source_title": "Biohaven Kv7 Ion Channel Modulation Platform",
  ...
  "hard_filter": {
    "status": "SELECT",
    "reason": "Asset identity verified and TR/MOA/Data are all >=2; same-class competitor to NS-041.",
    "flags": [
      "fast_triage_only",
      "same_target_competitor",
      "pivotal_program"
    ],
    "hard_blocker": false,
  ...
  "scoring": {
    "criteria": {
      "target_relevance": {
        ...
        "evidence_basis": "",
        "main_line_summary": "Kv7.2/Kv7.3 directly fits E/I Balance ion-channel biology.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "moa_validity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Selective Kv7.2/7.3 activation is clinically plausible and directly relevant to seizure hyperexcitability.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [],
        "source_ids": [
      ...
      "data_maturity": {
        ...
        "evidence_type_reason": "",
        "evidence_basis": "",
        "main_line_summary": "Pivotal epilepsy development and clinical data signals are visible.",
        "why_not_higher": "",
        "investigation_note": "",
        "uncertain_points": [
          "Full pivotal readout not assessed in fast triage."
    ...
    "source_registry": [
      {
        ...
        "reliability": "high",
        "evidence_summary": "Opakalim is described as a potent selective Kv7.2/7.3 activator."
      },
      {
        "source_id": "SRC_0024ec1ba0e0",
        "source_title": "Biohaven Reports New Clinical Data in Epilepsy with Opakalim",
        ...
        "source_type": "news",
        "reliability": "medium",
        "evidence_summary": "New clinical data in epilepsy with selective Kv7.2/7.3 activator opakalim."
      }
    ]
  },
  "final_insight": {
    "one_line_summary": "Strong same-class Kv7.2/7.3 comparator; run Full Scout.",
    "recommendation": "Run Full Scout",
    "most_important_diligence_question": "Does opakalim show better tolerability or variant coverage than azetukalner/NS-041?"
  },
  "triage": {
    "status": "SELECT",
    ...
    "why": "Same target/MoA as NS-041 with visible clinical development and epilepsy data.",
    "missing_evidence_needed_for_full_scout": [
      "Controlled pivotal efficacy results",
      "Detailed safety/tolerability comparison versus azetukalner and retigabine",
      "DEE/KCNQ2 variant-specific efficacy data"
    ]
  }
}
```
