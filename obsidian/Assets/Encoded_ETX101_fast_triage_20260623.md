...
|---|---:|---|---|---|---|---|
| Target Relevance | 3 | triage_only | - | SCN1A is directly linked to Dravet syndrome and E/I imbalance. | - | - |
| Competitive Landscape | - | - | - | - | - | - |
| MoA Validity | 3 | triage_only | - | AAV-mediated SCN1A expression increase is a clear root-cause strategy. | - | - |
| Platform Attractiveness | - | - | - | - | - | - |
| Expansion Potential | - | - | - | - | - | - |
| Data Maturity | 3 | triage_only | - | Phase 1/2 interim efficacy data and trial registry are visible. | - | - |
| Marketability | - | - | - | - | - | - |
...
```json
{
  ...
  "input": {
    ...
    "notes": "위 10개 약물 fast triage row #8"
  },
  "source_report": {
  ...
  "json_summary": {
    ...
    "one_line_summary": "SCN1A-positive Dravet syndrome을 겨냥한 one-time gene regulation therapy로 Phase 1/2 interim efficacy가 확인되어 Full Scout 가치가 높다.",
  ...
  "scoring": {
    ...
    "criteria": {
      ...
      "moa_validity": {
        ...
        "evidence_sources": [
          "https://encoded.com/press-releases/encoded-therapeutics-presents-positive-interim-efficacy-data-from-initial-dose-levels-of-phase-1-2-trials-evaluating-etx101-gene-therapy-in-dravet-syndrome/"
        ],
        "uncertain_points": []
      },
      "data_maturity": {
