...
export function englishCriteriaGuideMarkup() {
  return `
    <section class="criteria-rule criteria-triage-rule" data-criteria-tab="triage">
      <h3>GPT Instruction 1 — Simple Research · v3.7</h3>
      <p>Simple Research rapidly identifies candidates that merit Advanced Research review. It independently assesses Target Area Relevance, MoA Validity, and Data Maturity, then assigns SELECT, REJECT, or INSUFFICIENT.</p>
    </section>
    ...
    <section class="criteria-pass-grid triage-status-grid criteria-guide-section" aria-label="SELECT REJECT INSUFFICIENT triage criteria" data-criteria-tab="triage">
      ...
      <article class="criteria-status-card" data-triage-status="select"><div class="criteria-status-heading"><h3>SELECT</h3></div><p class="criteria-status-subtitle">Eligible for in-depth Advanced Research review; this is not a final BD recommendation.</p><ul><li>TAR ≥ 3</li><li>MoA ≥ 1 and Data ≥ 2</li></ul></article>
      <article class="criteria-status-card" data-triage-status="reject"><div class="criteria-status-heading"><h3>REJECT</h3></div><p class="criteria-status-subtitle">Current public evidence does not justify Advanced Research, but the candidate may be reassessed when new evidence is available.</p><ul><li>Asset identity is verified, but SELECT criteria are not met</li><li>TAR, MoA, and Data are all at least 1</li></ul></article>
    ...
    <section class="criteria-parameter-guide triage-parameter-guide criteria-guide-section" data-criteria-tab="triage">
      <div class="criteria-guide-section-heading"><span class="criteria-guide-step-number" aria-hidden="true">3</span><span class="criteria-guide-section-copy"><h3>Parameter Guide</h3><p>What each Simple Research criterion evaluates</p></span></div>
    ...
    <section class="criteria-pass-grid full-status-grid criteria-guide-section" aria-label="PASS MONITOR T·Down criteria" data-criteria-tab="full">
      ...
      <article class="criteria-status-card" data-full-status="pass"><div class="criteria-status-heading"><h3>PASS</h3></div><div class="criteria-full-status-summary-slot"><p class="criteria-full-status-summary">Candidate meeting all Advanced Research total-score and required-score gates for follow-up BD review.</p></div><ul><li>Total Score ≥ 14</li><li>Target Area Relevance ≥ 3</li><li>MoA Validity = 3 and Data Maturity = 3</li></ul></article>
    ...
    <section class="criteria-scoring-section criteria-guide-section" data-criteria-tab="full">
      ...
      <div class="criteria-table-wrap"><table class="criteria-table">${scoreHeader}<tbody>
        ...
        <tr><th>Competitive Landscape</th><td>Search evidence is insufficient to assess appropriate comparators and the competitive context</td><td>Competitors found, but differentiation is claim/concept only</td><td>Asset-specific quantitative differentiation versus an appropriate benchmark comparator, or substantiated entry space</td><td>Score-2 evidence plus direct head-to-head quantitative comparison with an appropriate comparator confirming material advantage</td></tr>
        <tr><th>Platform Attractiveness</th><td>No reusable platform or verifiable technical advantage</td><td>Reusable concept with rationale only</td><td>One quantitative technical advantage versus an appropriate comparator, at a single condition/asset level</td><td>Score-2 conditions met plus either the same advantage reproduced across independent conditions or officially linked assets, or First Patient Dosed by an officially linked platform-derived asset</td></tr>
        <tr><th>Expansion Potential</th><td>No additional indication confirmed</td><td>Additional-indication rationale only</td><td>Assessed-asset early quantitative efficacy, PD, or biomarker data in at least one additional indication</td><td>Score-2 evidence plus an official preclinical/IND-enabling/clinical program for that same additional indication</td></tr>
    ...
    <section class="criteria-parameter-guide full-parameter-guide criteria-guide-section" data-criteria-tab="full">
      <div class="criteria-guide-section-heading"><span class="criteria-guide-step-number" aria-hidden="true">3</span><span class="criteria-guide-section-copy"><h3>Parameter Guide</h3><p>What each Advanced Research criterion evaluates</p></span></div>
      <div class="criteria-detail-grid compact-criteria-detail-grid full-parameter-grid">
        ...
        <article class="full-parameter-card"><h3>MoA Validity</h3><p>Specificity and validation of the proposed mechanism. Generic clinical efficacy alone is not MoA 3. For Score 2 or 3, use one investigation-note sentence to distinguish disease-relevant phenotype/efficacy/biomarker linkage from proximal evidence such as a cellular-signaling marker; omit it for Score 0 or 1. Write <code>확인 불가</code> if the existing scoring evidence cannot establish this.</p></article>
        ...
        <article class="full-parameter-card"><h3>Competitive Landscape</h3><p>Comparator-backed competitive position and verified differentiation. Score 3 requires direct head-to-head quantitative evidence of material advantage; trivial numerical differences are not material.</p></article>
        ...
        <article class="full-parameter-card"><h3>Expansion Potential</h3><p>Confirmed expansion of the assessed asset beyond its main indication, not merely class-level biological plausibility. For Score 1–3, the investigation note states whether additional indications are single or multiple and each indication's assessed-asset program/data status, using only existing scoring evidence; otherwise write <code>확인 불가</code>.</p></article>
    ...
    <section class="criteria-rule criteria-focus-rule" data-criteria-tab="focus"><h3>Filter 3 — OI Partnership Classification · v1.7</h3><p>Classifies Advanced Research candidates placed on Custom Review as Investment, Value Up, Joint Research, Unknown, or N/A from verified structured values and confirmed source materials. Target indication uses the same six canonical Advanced Research priority indications and synonym mapping.</p></section>
    <section class="criteria-focus-section criteria-guide-section" data-criteria-tab="focus"><div class="criteria-guide-section-heading"><span class="criteria-guide-step-number" aria-hidden="true">1</span><span class="criteria-guide-section-copy"><h3>Eligibility and Input Basis</h3><p>Verified information used for automated classification</p></span></div><div class="criteria-focus-grid criteria-focus-input-grid"><article class="criteria-focus-info-card"><h4>Eligible candidates</h4><p>Only pipelines placed on Custom Review after Advanced Research are classified.</p></article><article class="criteria-focus-info-card"><h4>SKBP priority indications</h4><p>Alzheimer's disease; Parkinson's disease; amyotrophic lateral sclerosis / motor neuron disease; multiple sclerosis / neuroinflammatory disease; neuropathic pain; epilepsy / seizure disorders.</p></article><article class="criteria-focus-info-card"><h4>Confirmed inputs only</h4><p>Do not infer missing structured values or source facts.</p></article></div></section>
    <section class="criteria-focus-section criteria-guide-section" data-criteria-tab="focus"><div class="criteria-guide-section-heading"><span class="criteria-guide-step-number" aria-hidden="true">2</span><span class="criteria-guide-section-copy"><h3>Partnership Type</h3><p>Classification gates</p></span></div><div class="criteria-focus-grid criteria-focus-decision-grid"><article class="criteria-focus-decision-card" data-focus-decision="investment"><h4>Investment</h4><p>All modalities at IND-enabling stage or later; non-small-molecule preferred.</p></article><article class="criteria-focus-decision-card" data-focus-decision="value-up"><h4>Value Up</h4><p>Small-molecule asset before IND-enabling with in-vivo and in-vitro evidence and completed, scored ADMET data.</p></article><article class="criteria-focus-decision-card" data-focus-decision="joint-research"><h4>Joint Research</h4><p>Any modality with Platform Attractiveness = 3.</p></article></div></section>
...
export const ENGLISH_CRITERIA_DRAWER_CHROME = {
  ...
  subtitles: {
    triage: 'Three-criterion screen for candidates that may proceed to Advanced Research',
    full: 'Seven-criterion assessment for scientific, development, and commercial fit',
    focus: 'Automated OI partnership classification and follow-up guide for Custom Review candidates'
  }
};
