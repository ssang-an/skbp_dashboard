...
export function englishCriteriaGuideMarkup() {
  return `
    <section class="criteria-rule criteria-triage-rule" data-criteria-tab="triage">
      <h3>GPT Instruction 1 — Fast Triage · v3.4</h3>
    ...
    <section class="criteria-pass-grid triage-status-grid criteria-guide-section" aria-label="SELECT REJECT INSUFFICIENT triage criteria" data-criteria-tab="triage">
      ...
      <article class="criteria-status-card" data-triage-status="select"><div class="criteria-status-heading"><h3>SELECT</h3></div><p class="criteria-status-subtitle">Eligible for in-depth Full Scout review; this is not a final BD recommendation.</p><ul><li>TR ≥ 2</li><li>MoA ≥ 1 and Data ≥ 2</li></ul></article>
      <article class="criteria-status-card" data-triage-status="reject"><div class="criteria-status-heading"><h3>REJECT</h3></div><p class="criteria-status-subtitle">Current public evidence does not justify Full Scout, but the candidate may be reassessed when new evidence is available.</p><ul><li>Asset identity is verified, but SELECT criteria are not met</li><li>TR, MoA, and Data are all at least 1</li></ul></article>
      <article class="criteria-status-card" data-triage-status="insufficient"><div class="criteria-status-heading"><h3>INSUFFICIENT</h3></div><p class="criteria-status-subtitle">A valid assessment cannot be completed because of an early-stop reason or missing minimum evidence.</p><ul><li>Asset identity cannot be verified, or permanent discontinuation is confirmed</li><li>After identity verification, any of TR, MoA, or Data is 0</li></ul></article>
    </section>

    <section class="criteria-scoring-section criteria-guide-section" data-criteria-tab="triage">
      <div class="criteria-guide-section-heading"><span class="criteria-guide-step-number" aria-hidden="true">2</span><span class="criteria-guide-section-copy"><h3>Scoring Table</h3><p>0–3 score definitions for TR, MoA, and Data</p></span></div>
      <div class="criteria-table-wrap"><table class="criteria-table">${scoreHeader}<tbody>
        <tr><th>TR — Target Area Relevance</th><td>Identity is verified, but indication/relevance remains insufficiently known</td><td>Verified asset is outside the broad SKBP scope</td><td>Within the broad SKBP scope, but outside the six priority indications</td><td>One of the <strong>six SKBP priority indications</strong></td></tr>
        <tr><th>MoA — MoA Validity</th><td>Target or MoA cannot be confirmed</td><td>Company claim or theoretical rationale only</td><td>Functional evidence, or independent same-target/class validation</td><td><strong>Assessed asset directly validates the proposed MoA</strong><br />(target engagement, mechanism-linked PD/biomarker, or direct functional effect)</td></tr>
      ...
      <ul class="criteria-table-footnote"><li>INSUFFICIENT applies to identity/discontinuation early stops, or to a completed assessment with TR, MoA, or Data at 0.</li><li>A zero score after identity verification is an actual evaluated score, not a dash.</li></ul>
    </section>
    ...
    <section class="criteria-rule triage-evidence-note criteria-guide-section" data-criteria-tab="triage">
      ...
      <dl class="criteria-evidence-definitions">
        <div><dt><span class="criteria-guide-icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path d="M12 12a4 4 0 1 0 0-8ZM5 21a7 7 0 0 1 14 0" /><path d="m17 13 1.5 1.5L21 12" /></svg></span><span>User-provided information</span></dt><dd><ul><li>Facts supplied by the user</li><li>Eligible for TR assessment</li></ul></dd></div>
        ...
        <div><dt><span class="criteria-guide-icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false"><path d="M12 3 5 6v5c0 4.7 2.8 8 7 10 4.2-2 7-5.3 7-10V6l-7-3Z" /><path d="m9 12 2 2 4-4" /></svg></span><span>Scoring rule</span></dt><dd><ul><li>TR may use user-provided information and public sources</li><li>MoA and Data scores of 2 or higher require public, asset-specific evidence</li></ul></dd></div>
      </dl>
    </section>

    <section class="criteria-rule criteria-full-rule" data-criteria-tab="full">
      <h3>GPT Instruction 2 — Full Scout · v3.6</h3>
    ...
    <section class="criteria-pass-grid full-status-grid criteria-guide-section" aria-label="PASS REVIEW FAIL criteria" data-criteria-tab="full">
      ...
      <article class="criteria-status-card" data-full-status="pass"><div class="criteria-status-heading"><h3>PASS</h3></div><div class="criteria-full-status-summary-slot"><p class="criteria-full-status-summary">Candidate meeting all Full Scout total-score and required-score gates for follow-up BD review.</p></div><ul><li>Total Score ≥ 14</li><li>Target Area Relevance ≥ 2</li><li>MoA Validity = 3 and Data Maturity = 3</li></ul></article>
    ...
    <section class="criteria-scoring-section criteria-guide-section" data-criteria-tab="full">
      ...
      <div class="criteria-table-wrap"><table class="criteria-table">${scoreHeader}<tbody>
        <tr><th>Target Area Relevance</th><td>Identity is verified, but indication/relevance remains insufficiently known</td><td>Verified asset is outside broad SKBP scope</td><td>Within broad SKBP scope but outside six priorities</td><td>One of <strong>six SKBP priority indications</strong></td></tr>
        ...
        <tr><th>Competitive Landscape</th><td>Search evidence is insufficient to assess direct competitors</td><td>Competitors found, but differentiation is claim/concept only</td><td>Asset-specific quantitative differentiation or realistic entry space</td><td>Limited high-similarity competitors and strong quantitative differentiation or verified leading position</td></tr>
    ...
    <section class="criteria-parameter-guide full-parameter-guide criteria-guide-section" data-criteria-tab="full">
      ...
      <div class="criteria-detail-grid compact-criteria-detail-grid full-parameter-grid">
        <article class="target-parameter-card full-parameter-card"><div class="criteria-parameter-heading criteria-parameter-title-row"><h3><b>TR</b><span>Target Area Relevance</span></h3></div><p>Assesses whether the verified asset indication fits SKBP strategic scope. Theme/Cluster and disease-biology linkage are classification and MoA inputs, not TR score bases.</p><ul class="parameter-evidence-list"><li><strong>Priority indications</strong><span>Alzheimer's disease; Parkinson's disease; ALS/MND; multiple sclerosis/neuroinflammatory disease; neuropathic pain; epilepsy/seizure disorders</span></li><li><strong>Broad SKBP scope</strong><span>Neurological, psychiatric, neuroimmune, neurodegenerative, and pain conditions</span></li></ul></article>
        ...
        <article class="full-parameter-card"><h3>Competitive Landscape</h3><p>Direct competitive position and verified differentiation; separate true same-target/MoA competitors from broader disease competitors.</p></article>
