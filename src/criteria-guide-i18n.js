...
export function englishCriteriaGuideMarkup() {
  return `
    ...
    <section class="criteria-rule criteria-full-rule" data-criteria-tab="full">
      <h3>GPT Instruction 2 — Full Scout · v3.8</h3>
    ...
    <section class="criteria-rule criteria-focus-rule" data-criteria-tab="focus"><h3>Filter 3 — OI Partnership Classification · v1.7</h3><p>Classifies shortlisted Full Scout candidates as Investment, Value Up, Joint Research, Unknown, or N/A from verified structured values and confirmed source materials. Target indication uses the same six canonical Full Scout priority indications and synonym mapping.</p></section>
