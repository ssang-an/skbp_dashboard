...
export function englishCriteriaGuideMarkup() {
  return `
    ...
    <section class="criteria-pass-grid triage-status-grid criteria-guide-section" aria-label="SELECT REJECT INSUFFICIENT triage criteria" data-criteria-tab="triage">
      ...
      <article class="criteria-status-card" data-triage-status="select"><div class="criteria-status-heading"><h3>SELECT</h3></div><p class="criteria-status-subtitle">Eligible for in-depth Full Scout review; this is not a final BD recommendation.</p><ul><li>TR ≥ 3</li><li>MoA ≥ 1 and Data ≥ 2</li></ul></article>
