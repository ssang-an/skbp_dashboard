...
class DashboardInformationArchitectureTests(unittest.TestCase):
    ...
    def test_step0_workflow_map_uses_filtered_rows_and_g6_stage_nodes(self):
        ...
        self.assertIn('step0WorkflowGridShape(nodes.length, width, height)', workflow_map)
        self.assertIn("type: 'grid'", workflow_map)
        self.assertIn('condense: false', workflow_map)
        self.assertIn('preventOverlap: false', workflow_map)
