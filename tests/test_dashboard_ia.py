...
class DashboardInformationArchitectureTests(unittest.TestCase):
    ...
    def test_step0_workflow_map_uses_filtered_rows_and_g6_stage_nodes(self):
        ...
        self.assertIn('STEP0_WORKFLOW_FORCE_SETTINGS', JS)
        self.assertIn('anchorX: position.x', workflow_map)
        self.assertIn('anchorY: position.y', workflow_map)
        ...
        self.assertIn('iterations: 26', workflow_map)
        self.assertIn('setTimeout(() => {', workflow_map)
