...
class DashboardInformationArchitectureTests(unittest.TestCase):
    ...
    def test_review_workspace_uses_compact_version_refresh_pills_and_owner_meta(self):
        ...
        self.assertIn("border: 1px solid color-mix(in srgb, #b9616b 55%, var(--line))", collaboration)
        ...
        self.assertIn("border: 1px solid color-mix(in srgb, #b9616b 55%, var(--line))", CSS)
        self.assertIn('#detailScoreSequence .score-chip[data-manual-score="true"]', CSS)
        self.assertIn("outline: none !important", CSS)
        self.assertIn("styles.css?v=20260819-manual-score-chip-8", DETAIL_HTML)
        self.assertIn("detail.js?v=20260819-manual-score-chip-8", DETAIL_HTML)
