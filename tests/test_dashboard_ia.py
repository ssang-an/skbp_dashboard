...
class DashboardInformationArchitectureTests(unittest.TestCase):
    ...
    def test_review_workspace_uses_compact_version_refresh_pills_and_owner_meta(self):
        ...
        self.assertIn("border: 2px solid #b54552", collaboration)
        ...
        self.assertIn("outline: 1px solid", CSS)
        self.assertIn("styles.css?v=20260819-manual-score-chip-6", DETAIL_HTML)
        self.assertIn("detail.js?v=20260819-manual-score-chip-6", DETAIL_HTML)
